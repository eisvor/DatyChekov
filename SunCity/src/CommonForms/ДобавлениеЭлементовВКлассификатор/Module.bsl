...
Процедура ПриСозданииНаСервере(Отказ, СтандартнаяОбработка)
	...
	Элементы.ПрослеживаемыйТовар.Видимость = ИсточникДанных = "КлассификаторТНВЭД"
												И УчетПрослеживаемыхТоваровРТ.ИспользоватьУчетПрослеживаемыхИмпортныхТоваров(
													Дата(1, 1, 1));
...
//  Неопределено или СправочникСсылка - КлассификаторВидовЭкономическойДеятельности 
...
// Параметры:
//  ВыбраннаяСтрока - СтрокаТаблицыЗначений - источник данных для заполнения реквизитов классификатора.
...
Процедура ДобавитьЭлементКлассификатора(ВыбраннаяСтрока)
	...
	Если ЗначениеЗаполнено(ВыбраннаяСтрока.ЕдиницаИзмеренияКод)
		...
		СоответствиеКодов = Справочники.БазовыеЕдиницыИзмерения.ЗаполнитьЕдиницыИзмеренияИзКлассификатора(ВыбраннаяСтрока.ЕдиницаИзмеренияКод);
...
//  СписокЗначений  - сприсок значений с версиями списков отчета
//

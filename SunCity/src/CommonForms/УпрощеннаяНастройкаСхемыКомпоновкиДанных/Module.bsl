...
// Обработка процедуры выбора шаблона
//
// Параметры:
//  Результат - Структура - структура результат выполнения операции.
...
Процедура ПриСозданииНаСервере(Отказ, СтандартнаяОбработка)
	...
	Если НЕ Параметры.ИсточникШаблонов = Неопределено Тогда
		...
		Если Параметры.Свойство("ФильтрИсточникаШаблонов") Тогда
			ФильтрИсточникаШаблонов = Параметры.ФильтрИсточникаШаблонов;
		КонецЕсли;
		
		Для каждого Макет Из ИсточникШаблоновОбъектМетаданных.Макеты Цикл
			Если Макет.ТипМакета = Метаданные.СвойстваОбъектов.ТипМакета.СхемаКомпоновкиДанных Тогда
				Если ФильтрИсточникаШаблонов = Неопределено
					ИЛИ ФильтрИсточникаШаблонов.Найти(Макет.Имя) <> Неопределено Тогда

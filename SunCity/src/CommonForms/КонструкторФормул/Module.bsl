...
Процедура ПриСозданииНаСервере(Отказ, СтандартнаяОбработка)
	...
	Если НЕ Параметры.Свойство("Формула") Тогда
		ТекстИсключения = НСтр("ru = 'Форма открывается из элемента справочника Виды цен.
									 |Маркетинг -> Виды цен.'");
...
Процедура ОперандыНачалоПеретаскивания(Элемент, ПараметрыПеретаскивания, СтандартнаяОбработка)
	...
	ПараметрыПеретаскивания.Значение = РаботаСФормуламиКлиентСервер.ТекстОперандаДляВставки(Элемент.ТекущиеДанные.Значение);
...
Процедура ВставитьОперандВФормулу()
	ВставитьТекстВФормулу(РаботаСФормуламиКлиентСервер.ТекстОперандаДляВставки(Элементы.Операнды.ТекущиеДанные.Значение));
КонецПроцедуры

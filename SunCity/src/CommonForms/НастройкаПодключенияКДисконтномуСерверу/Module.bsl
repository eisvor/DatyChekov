...
Процедура ПередЗаписью(Отказ, ПараметрыЗаписи)
	...
	Если НЕ ЗначениеЗаполнено(НаборКонстант.АдресДисконтногоСервера) Тогда
		...
		ОбщегоНазначенияКлиент.СообщитьПользователю(СтрокаСообщения, , "АдресДисконтногоСервера", "НаборКонстант");
		Отказ = Истина;
	КонецЕсли;
...
Функция ПроверитьПодключениеКДисконтномуСерверуНаСервере()
	...
	Если НЕ ЗначениеЗаполнено(НаборКонстант.АдресДисконтногоСервера) Тогда
		СтрокаСообщения = НСтр("ru = 'Не заполнен адрес дисконтного сервера'");
		ОбщегоНазначения.СообщитьПользователю(СтрокаСообщения, , "АдресДисконтногоСервера", "НаборКонстант");

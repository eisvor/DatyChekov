...
&НаКлиенте
Перем ПроверкаКонтрагентовПараметрыОбработчикаОжидания;
...
Процедура СформироватьОтчет(Команда)
	...
	Если РезультатВыполнения.Статус <> "Выполнено" Тогда
		НачатьОжиданиеДлительнойОперации(РезультатВыполнения);
...
&НаКлиенте
Процедура НачатьОжиданиеДлительнойОперации(РезультатВыполнения)
	
	ОповещениеОЗавершении = Новый ОписаниеОповещения("ПроверитьВыполнениеЗадания", ЭтотОбъект);
...
Функция СформироватьОтчетНаСервере()
	...
	Иначе
		...
		НСтр("ru = 'Формирование отчета ""Журнал счетов-фактур""'");
		
		РезультатВыполнения = ДлительныеОперации.ВыполнитьВФоне(
			"УправлениеПечатьюРТ.ПодготовитьПараметрыЖурналаУчетаСчетовФактур", ПараметрыОтчета, ПараметрыВыполнения);
...
&НаКлиенте
Процедура ПроверитьВыполнениеЗадания(Результат, ДополнительныеПараметры) Экспорт

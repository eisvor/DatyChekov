...
Процедура ПриКомпоновкеРезультата(ДокументРезультат, ДанныеРасшифровки, СтандартнаяОбработка)
	...
	Если Диаграмма Тогда
		...
		ТекстИнтервала = МаркетинговыеАкцииСервер.ОписаниеИнтервалаДиаграммы(Интервал);
		ТекстЗаголовка = НСтр("ru = 'Оценка применения скидок (%1)'");
		ТекстЗаголовка = СтроковыеФункцииКлиентСервер.ПодставитьПараметрыВСтроку(ТекстЗаголовка, ТекстИнтервала);
		ПараметрЗаголовка.Значение = ТекстЗаголовка;
		
	Иначе

		ПараметрЗаголовка.Значение = НСтр("ru = 'Оценка применения скидок'") + " " + ОписаниеПериодаПриведения;

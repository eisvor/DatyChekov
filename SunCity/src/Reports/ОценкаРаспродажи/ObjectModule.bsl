...
Процедура ПриКомпоновкеРезультата(ДокументРезультат, ДанныеРасшифровки, СтандартнаяОбработка)
	...
	Если Диаграмма Тогда
		ПараметрЗаголовка.Значение = НСтр("ru = 'Оценка распродажи'") + " "
			+ "(" + МаркетинговыеАкцииСервер.ОписаниеИнтервалаДиаграммы(Интервал) +")";
	Иначе
		ПараметрЗаголовка.Значение = НСтр("ru = 'Оценка распродажи'") + " " + ОписаниеПериодаПриведения;
	КонецЕсли;

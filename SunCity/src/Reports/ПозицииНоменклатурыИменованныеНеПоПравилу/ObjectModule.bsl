...
Процедура ПриКомпоновкеРезультата(ДокументРезультат, ДанныеРасшифровки, СтандартнаяОбработка)
	...
	Пока Выборка.Следующий() Цикл
		...
		СтруктураПараметров = РаботаСПравиламиИменования.СтруктураПараметровПравилаИменования(Выборка.ВидНоменклатуры);		
		...
		РезультатЗапроса = РаботаСПравиламиИменования.ЗначенияПараметровНоменклатуры(Выборка.ВидНоменклатуры,СтруктураПараметров.ПараметрыПравилаИменования);

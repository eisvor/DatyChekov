...
Процедура ПриКомпоновкеРезультата(ДокументРезультат, ДанныеРасшифровки, СтандартнаяОбработка)
	...
	ДокументРезультат.КлючПараметровПечати = "Отчет.ТоварныйОтчетТОРГ29/КлючВарианта.ТоварныйОтчетТОРГ29";;
...
Функция СформироватьОтчетТОРГ29(ДатаНачала, ДатаОкончания, Склад, Организация, НомерОтчета)
	...
	Если РазделятьПриходыИРасходы Тогда
	...
	ВидЦены = СтрШаблон(НСтр("ru='Отчет сформирован в ценах: %1'"), Магазин.ПравилоЦенообразования.ВидЦен);

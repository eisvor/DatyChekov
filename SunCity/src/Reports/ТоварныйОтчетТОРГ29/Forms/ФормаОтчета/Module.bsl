...
Процедура ПриОбновленииСоставаПользовательскихНастроекНаСервере(СтандартнаяОбработка)
	Результат.КлючПараметровПечати = "Отчет.ТоварныйОтчетТОРГ29/КлючВарианта.ТоварныйОтчетТОРГ29";
КонецПроцедуры
...
Процедура ЗаполнитьЗначениямиПоУмолчанию(Настройки)
	...
	Если НЕ ЗначениеЗаполнено(Настройки.Получить("Отчет.Организация")) Тогда
		...
		Отчет.Организация = ЗначениеНастроекПовтИсп.ОрганизацияПоУмолчанию(Отчет.Организация);
	...
	Если НЕ ЗначениеЗаполнено(Настройки.Получить("Отчет.Магазин")) Тогда
		...
		Отчет.Магазин = ЗначениеНастроекПовтИсп.МагазинПоУмолчанию(Отчет.Магазин);
	...
	Если НЕ ЗначениеЗаполнено(Настройки.Получить("Отчет.Склад")) Тогда
		...
		Отчет.Склад = ЗначениеНастроекПовтИсп.СкладПродажиПоУмолчанию(Отчет.Магазин,,Отчет.Склад, Пользователи.ТекущийПользователь());
...
Процедура ПриИзмененииМагазина()
	Отчет.Склад = ЗначениеНастроекПовтИсп.СкладПоступленияПоУмолчанию(Отчет.Магазин,,Отчет.Склад, Пользователи.ТекущийПользователь());		
КонецПроцедуры

...
Процедура ПриКомпоновкеРезультата(ДокументРезультат, ДанныеРасшифровки, СтандартнаяОбработка)
	...
	ЗначениеПараметраМаркетинговаяАкция = КомпоновщикНастроек.Настройки.ПараметрыДанных.НайтиЗначениеПараметра(Новый ПараметрКомпоновкиДанных("МаркетинговаяАкция"));
	Если ЗначениеПараметраМаркетинговаяАкция <> Неопределено Тогда
		ЗначениеПараметраМаркетинговаяАкция.Значение = МаркетинговаяАкция;
		ЗначениеПараметраМаркетинговаяАкция.Использование = Истина;
	КонецЕсли;
	
	ЗначениеПараметраИнтервал = КомпоновщикНастроек.Настройки.ПараметрыДанных.НайтиЗначениеПараметра(Новый ПараметрКомпоновкиДанных("Интервал"));
	Если ЗначениеПараметраИнтервал <> Неопределено Тогда
		ЗначениеПараметраИнтервал.Значение = Интервал;
		ЗначениеПараметраИнтервал.Использование = Истина;
	КонецЕсли;
	...
	ПараметрЗаголовка.Значение = НСтр("ru = 'Оценка эффективности маркетинговых мероприятий'") + " " + ОписаниеПериодаПриведения;

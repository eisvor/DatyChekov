...
Процедура ПриСозданииНаСервере(Отказ, СтандартнаяОбработка)
	...
	СписокПараметров = "КратностьЧисел, 
					   |РазрезАналитики, 
	...
	ЗаполнитьЗначенияСвойств(ЭтаФорма, Параметры, СписокПараметров);
...
Процедура СписокОтчетовВидОтображенияПриИзменении(Элемент)
	...
	Если Не ТекущиеДанные = Неопределено Тогда
		...
		Если ТекущиеДанные.ВидОтображения = ПредопределенноеЗначение("Перечисление.ВидыДиаграмм.Измерительная")
			Или ТекущиеДанные.ВидОтображения = ПредопределенноеЗначение("Перечисление.ВидыДиаграмм.Круговая")
			Или ТекущиеДанные.ВидОтображения = ПредопределенноеЗначение("Перечисление.ВидыДиаграмм.КруговаяОбъемная") Тогда 

...
Функция АвтоНаименованиеКассы()
	...
	СтрокаНаименования = Нстр("ru='%1 (%2) %3'");
	СтрокаНаименования = СтрШаблон(СтрокаНаименования, СокрЛП(Объект.Владелец), СокрЛП(Объект.Магазин), ?(Объект.КассаУправляющейСистемы, " управ. система", ""));

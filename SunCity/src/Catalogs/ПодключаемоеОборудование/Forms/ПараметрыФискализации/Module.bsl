...
Процедура ОбновитьСостояниеФормы()
	...
	Элементы.ГруппаПричиныИзмененияСведенийОККТ.Видимость = (ТипОперации = 2) И ((ВерсияФФДККТ = "1.1") Или (ВерсияФФДККТ = "1.2"));
	Элементы.ГруппаНастройкиККТ12.Видимость = (ТипОперации = 2) И (ВерсияФФДККТ = "1.2");

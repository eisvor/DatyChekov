...
// Обрабатывает результат выбора формулы расчета цены
// 
// Параметры:
...
// Обрабатывает результат работы конструктора психологического округления.
// 
// Параметры:
//  Результат - Произвольный - результат выполнения операции.
//  ДополнительныеПараметры - Структура - структура дополнительных параметров.
...
// Обрабатывает результат работы конструктора схемы компоновки данных.
// 
// Параметры:
//  Результат - Произвольный - результат выполнения операции.
//  ДополнительныеПараметры - Структура - структура дополнительных параметров.
...
// Обрабатывает результат работы конструктора формул.
// 
// Параметры:
//  Результат - Произвольный - результат выполнения операции.
//  ДополнительныеПараметры - Структура - структура дополнительных параметров.
...
Процедура СообщитьОбНДС()
	Если Ложь И Объект.ИспользоватьПриПродаже И НЕ Объект.ЦенаВключаетНДС Тогда
		...
		ОбщегоНазначенияКлиент.СообщитьПользователю(СтрокаСообщения, , "ЦенаВключаетНДС", "Объект");
	КонецЕсли;
КонецПроцедуры

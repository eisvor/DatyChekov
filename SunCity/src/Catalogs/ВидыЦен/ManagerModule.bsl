...
//                                                       организациями;
//  ИспользоватьПриПродаже - Булево - Доступность вида цен для продажи.
//
// Возвращаемое значение:
//  СправочникСсылка.ВидыЦен - Найденный вид цен.
//
Функция ВидЦеныПоУмолчанию(ИспользоватьПриПередачеМеждуОрганизациями = Неопределено, ИспользоватьПриПродаже = Неопределено) Экспорт
	...
	|	И &УсловиеИспользоватьПриПередачеМеждуОрганизациями
	|	И &УсловиеИспользоватьПриПродаже";
	
	Если ЗначениеЗаполнено(ИспользоватьПриПередачеМеждуОрганизациями) Тогда
		УсловиеИспользоватьПриПередачеМеждуОрганизациями = "ВидыЦен.ИспользоватьПриПередачеМеждуОрганизациями = &ИспользоватьПриПередачеМеждуОрганизациями";
		Запрос.УстановитьПараметр("ИспользоватьПриПередачеМеждуОрганизациями", ИспользоватьПриПередачеМеждуОрганизациями);
	Иначе
		УсловиеИспользоватьПриПередачеМеждуОрганизациями = "Истина";
	КонецЕсли;
	ТекстЗапроса = СтрЗаменить(ТекстЗапроса, "&УсловиеИспользоватьПриПередачеМеждуОрганизациями", УсловиеИспользоватьПриПередачеМеждуОрганизациями);
	
	Если ЗначениеЗаполнено(ИспользоватьПриПродаже) Тогда
		УсловиеИспользоватьПриПродаже = "ВидыЦен.ИспользоватьПриПродаже = &ИспользоватьПриПродаже";
		Запрос.УстановитьПараметр("ИспользоватьПриПродаже", ИспользоватьПриПродаже);
	Иначе
		УсловиеИспользоватьПриПродаже = "Истина";
	КонецЕсли;
	ТекстЗапроса = СтрЗаменить(ТекстЗапроса, "&УсловиеИспользоватьПриПродаже", УсловиеИспользоватьПриПродаже);
...
//
// Параметры:
//  ВидЦены - СправочникСсылка.ВидыЦены - Ссылка на вид цены.
//
// Возвращаемое значение:
...
Функция СформироватьНовуюСхемуКомпоновкиДанных() Экспорт
	...
	ОбязательныеПоля = Ценообразование.ОбязательныеПоляСхемыКомпоновкиДанных();

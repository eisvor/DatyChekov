...
Процедура ПриСозданииНаСервере(Отказ, СтандартнаяОбработка)
	...
	Элементы.ТипПодключаемогоОборудования.СписокВыбора.Вставить(0, Перечисления.ТипыПодключаемогоОборудования.ВесыСПечатьюЭтикеток, "Весы с печатью этикеток");
	Элементы.ТипПодключаемогоОборудования.СписокВыбора.Вставить(1, Перечисления.ТипыОфлайнОборудования.ККМ, "ККМ Офлайн");
	Элементы.ТипПодключаемогоОборудования.СписокВыбора.Вставить(2, Перечисления.ТипыОфлайнОборудования.ПрайсЧекер, "Прайс-чекер");
...
Функция ПоместитьВоВременноеХранилищеСервер()
	...
	ТоварыДляВыгрузки.Колонки.Добавить("НомерСтроки", ОбщегоНазначенияРТКлиентСервер.ОписаниеТиповЧисла(15, 0));
	СчетчикСтрок = 0;

...
// Обрабатывает редактирование схемы компоновки данных.
//
// Параметры:
//  Результат - Структура - структура результата.
//  ДополнительныеПараметры - Структура - структура дополнительных параметров.
...
// Обрабатывает настройку расписания.
//
// Параметры:
//  Результат - Структура - структура результата.
//  ДополнительныеПараметры - Структура - структура дополнительных параметров.
...
Процедура ПолучитьРасписаниеРегламентногоЗадания()
	...
	Иначе
		...
		Если ЗначениеЗаполнено(Объект.РегламентноеЗадание) Тогда
			...
			Если ЗаданияОбмена.Количество() = 1 Тогда
				...
				Расписание = ЗаданиеОбмена.Расписание;
				РегламентноеЗаданиеИспользуется = ЗаданиеОбмена.Использование;
				РасписаниеСтрокой = Строка(Расписание);
			КонецЕсли;
		КонецЕсли;
	КонецЕсли;

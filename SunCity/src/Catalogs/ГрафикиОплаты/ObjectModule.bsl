...
Процедура ОбработкаПроверкиЗаполнения(Отказ, ПроверяемыеРеквизиты)
	...
	Если КоличествоЭтапов >= 2 Тогда
		...
		Для ВнешнийСчетчик = 2 По КоличествоЭтапов Цикл
			...
			Если (ТекущееЗначениеВариантаОплаты = Перечисления.ВидПлатежа.Предоплата
				И (ПредыдущееЗначениеВариантаОплаты = Перечисления.ВидПлатежа.ОтсрочкаПлатежа)) Тогда
			...
			Если ((ТекущееЗначениеВариантаОплаты = Перечисления.ВидПлатежа.Предоплата
				И ПредыдущееЗначениеВариантаОплаты = Перечисления.ВидПлатежа.Предоплата)
				И ТекущееЗначениеСдвига > ПредыдущееЗначениеСдвига) Тогда
			...
			ИначеЕсли ((ТекущееЗначениеВариантаОплаты = Перечисления.ВидПлатежа.ОтсрочкаПлатежа
				И ПредыдущееЗначениеВариантаОплаты = ТекущееЗначениеВариантаОплаты)
				И ТекущееЗначениеСдвига < ПредыдущееЗначениеСдвига) Тогда

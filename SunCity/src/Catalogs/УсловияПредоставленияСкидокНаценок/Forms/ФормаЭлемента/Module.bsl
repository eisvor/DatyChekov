...
// Обрабатывает разблокирование реквизитов.
//
// Параметры:
//  Результат - Структура - результат разблокирования реквизитов.
...
// Обрабатывает ответ на вопрос о типе получателя.
//
// Параметры:
...
// Обрабатывает изменение настроек внешней обработки.
//
// Параметры:
...
Процедура ПриСозданииНаСервере(Отказ, СтандартнаяОбработка)
	...
	ОбщегоНазначенияРТ.УдалитьПараметрыВыбораРасширений(Элементы.ВнешняяОбработка.ПараметрыВыбора);
...
Функция СформироватьАвтоНаименованиеНаКлиенте()
	...
	ИначеЕсли Объект.УсловиеПредоставления = ПредопределенноеЗначение("Перечисление.УсловияПредоставленияСкидокНаценок.ЗаРазовыйОбъемПродаж") Тогда
		...
		+ ?(Объект.КритерийОграниченияПримененияЗаОбъемПродаж = ПредопределенноеЗначение("Перечисление.КритерииОграниченияПримененияСкидкиНаценкиЗаОбъемПродаж.Количество"), " " + НСтр("ru = 'ед.'"), " " + НСтр("ru = 'тг.'"))
...
Функция СформироватьАвтоНаименованиеНаСервере()
	...
	ИначеЕсли Объект.УсловиеПредоставления = Перечисления.УсловияПредоставленияСкидокНаценок.ЗаРазовыйОбъемПродаж Тогда
		...
		+ ?(Объект.КритерийОграниченияПримененияЗаОбъемПродаж = Перечисления.КритерииОграниченияПримененияСкидкиНаценкиЗаОбъемПродаж.Количество, " " + НСтр("ru = 'ед.'"), " " + НСтр("ru = 'тг.'"))
		+ ?(ЗначениеЗаполнено(Объект.СегментНоменклатурыОграничения)," " +НСтр("ru = 'по номенклатуре сегмента'")+ " " + Объект.СегментНоменклатурыОграничения, "");

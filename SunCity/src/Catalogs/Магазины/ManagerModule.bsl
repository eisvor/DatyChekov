...
//
Функция МагазинПоУмолчанию() Экспорт
...
Функция ПолучитьБлокируемыеРеквизитыОбъекта() Экспорт
	...
	Результат.Добавить("ОкруглениеТолькоПриОплатеНаличными");
...
//
// Возвращаемое значение:
//  Массив - редактируемые реквизиты.
//
...
//
// Параметры:
//  МассивОбъектов - Массив - массив объектов к печати.
...
Процедура Печать(МассивОбъектов, ПараметрыПечати, КоллекцияПечатныхФорм, ОбъектыПечати, ПараметрыВывода) Экспорт
	...
	Если УправлениеПечатью.НужноПечататьМакет(КоллекцияПечатныхФорм, "ГрафикРаботы") Тогда
		...
		УправлениеПечатью.ВывестиТабличныйДокументВКоллекцию(
			...
			"ГрафикРаботы",
			НСтр("ru='График работы магазина'"),

...
Процедура ПодготовитьФормуНаСервере()
	...
	Элементы.ОкруглениеТолькоПриОплатеНаличными.Доступность = ЗначениеЗаполнено(Объект.ПорядокОкругленияСуммыЧекаВПользуПокупателя);
...
Процедура ПроверитьДоступностьРеквизитов()
	...
	ДоступностьПравилаЦенообразования = ОбщегоНазначенияРТВызовСервера.РеквизитДоступен(Объект,
		"ПравилоЦенообразования",
		"Справочник.ПравилаЦенообразования");
	ДоступностьВидаЦен                = ОбщегоНазначенияРТВызовСервера.РеквизитДоступен(Объект,
	...
	ЦенаВключаетНДС = ОбщегоНазначенияРТ.ЗначениеРеквизитаВПривилегированномРежиме(Объект.ПравилоЦенообразования,
		"ЦенаВключаетНДС");
...
Процедура ПорядокОкругленияСуммыЧекаВПользуПокупателяПриИзменении(Элемент)
	...
	Если ЗначениеЗаполнено(Объект.ПорядокОкругленияСуммыЧекаВПользуПокупателя) Тогда
		...
		Элементы.ОкруглениеТолькоПриОплатеНаличными.Доступность = Истина;
	Иначе
		Элементы.ТипОкругленияЧекаВПользуПокупателя.Доступность = Ложь;
		Элементы.ОкруглениеТолькоПриОплатеНаличными.Доступность = Ложь;
		Объект.ТипОкругленияЧекаВПользуПокупателя = 0;
		Объект.ОкруглениеТолькоПриОплатеНаличными = Ложь;
		Элементы.ПорядокОкругленияСуммыЧекаВПользуПокупателя.Заголовок = НСтр("ru = 'Порядок округления суммы чека'");
	КонецЕсли;

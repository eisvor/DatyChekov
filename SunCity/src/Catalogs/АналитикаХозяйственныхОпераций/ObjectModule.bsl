...
//
// Параметры:
//  ИмяПредопределенногоЭлемента - Строка - наименование хозяйственной операции.
//
// Возвращаемое значение:
//  Перечисление.ХозяйственныеОперации - правильная хозяйственная операция.
//
Функция ПолучитьПравильнуюХозяйственнуюОперацию(ИмяПредопределенногоЭлемента = "") Экспорт
	...
	ИначеЕсли Ссылка = Справочники.АналитикаХозяйственныхОпераций.ПоступлениеКомиссионныхТоваров Тогда
		
		ИмяПредопределенногоЭлемента = НСтр("ru = 'Поступление комиссионных товаров'");

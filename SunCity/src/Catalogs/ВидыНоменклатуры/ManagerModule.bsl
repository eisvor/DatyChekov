...
//
// Параметры:
//  ВидНоменклатуры - СправочникСсылка.ВидыНоменклатуры - вид номенклатуры по которому ищутся характеристики.
//
// Возвращаемое значение:
//  СправочникСсылка.ВидНоменклатуры - Найденный вид номенклатуры.
//  Неопределено - если видов номенклатуры нет или видов номенклатуры больше одного.
...
Функция ПараметрыСерийНоменклатуры(ВидНоменклатуры, ВладелецСерии) Экспорт
	...
	СтруктураВозврата.Вставить("ВладелецСерии"  ,ВладелецСерии);
...
//
// Параметры:
//  ТочностьУказанияСрокаГодности - Перечисления.ТочностиУказанияСрокаГодности - нужно ли в сроке годности указывать часы.
//
// Возвращаемое значение:
//  Строка - форматная строка срока годности.
//
...
// Возвращает имена реквизитов для формы.
//
// Параметры:
//  Событие - Строка - внешнее событие.
//
// Возвращаемое значение:
//  Строка - имена реквизитов для формы.
//
...
// Возвращает настройки использования серий.
//
// Параметры:
//  ВидНоменклатуры   - СправочникСсылка.ВидыНоменклатуры - вид номенклатуры, параметры серий которого которой нужно получить
//  Магазин - СправочникСсылка.Магазины - магазин для которого нужно получить настройки серий.
//
//	Возвращаемое значение:
...
//
Функция НастройкиИспользованияСерий(ВидНоменклатуры, Магазин = Неопределено, Номенклатура = Неопределено) Экспорт
...
Процедура ЗаполнитьИспользованиеСерий() Экспорт
	...
	|	И ВидыНоменклатуры.ИспользованиеСерий = &ПустоеИспользованиеСерий";
	
	Запрос.УстановитьПараметр("ПустоеИспользованиеСерий", Перечисления.ВариантыВеденияДополнительныхДанныхПоНоменклатуре.ПустаяСсылка());
	...
	Пока Выборка.Следующий() Цикл
		...
		Если Выборка.ИспользоватьСерии Тогда
			ВидНоменклатурыОбъект.ИспользованиеСерий = Перечисления.ВариантыВеденияДополнительныхДанныхПоНоменклатуре.ОбщиеДляВидаНоменклатуры;
		Иначе
			ВидНоменклатурыОбъект.ИспользованиеСерий = Перечисления.ВариантыВеденияДополнительныхДанныхПоНоменклатуре.НеИспользовать;
		КонецЕсли;

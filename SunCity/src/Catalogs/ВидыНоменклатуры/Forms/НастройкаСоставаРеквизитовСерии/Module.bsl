...
Процедура ОК(Команда)
	...
	Если АвтоматическиГенерироватьСерии Тогда
		...
		Если Не ИспользоватьДатуПроизводстваСерии
			...
			ТекстСообщения = НСтр("ru = 'Автоматическая генерация серий возможна по реквизитам: ""Дата производства"", ""Производитель (ЕГАИС)"", ""Справка 2 (ЕГАИС)"". Включите использование одного из этих реквизитов.'");

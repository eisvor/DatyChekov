...
Процедура ПриСозданииНаСервере(Отказ, СтандартнаяОбработка)
		...
		Если ТипЗнч(НаборДопРеквизитов) = Тип("ГруппаФормы") Тогда
			...
			Для Каждого ПодчиненныйЭлемент Из НаборДопРеквизитов.ПодчиненныеЭлементы Цикл
				...
				Если ТипЗнч(ПодчиненныйЭлемент) = Тип("ПолеФормы") Тогда
					ПодчиненныйЭлемент.УстановитьДействие("ПриИзменении", "Подключаемый_ДопРеквизитПриИзменении");
				КонецЕсли;
	...
	Элементы.КиЗГИСМGTIN.Видимость = ТипЗнч(Объект.Владелец) = Тип("СправочникСсылка.Номенклатура") 
		И Объект.Владелец.КиЗГИСМ;
...
&НаКлиенте
Процедура Подключаемый_ДопРеквизитПриИзменении()

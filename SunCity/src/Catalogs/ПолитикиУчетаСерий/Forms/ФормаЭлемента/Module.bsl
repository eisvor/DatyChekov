...
Процедура УказыватьПриМаркировкеПродукцииДляГИСМПриИзменении(Элемент)
	...
	УстановитьДоступностьПоМаркировке(ЭтаФорма, Объект.УказыватьПриМаркировкеПродукцииДляГИСМ);
КонецПроцедуры
...
Процедура Подключаемый_РазрешитьРедактированиеРеквизитовОбъекта(Команда)
	...
	Если Не Объект.Ссылка.Пустая() Тогда
		ОбработкаОповещения = Новый ОписаниеОповещения("РазблокировкаРеквизитов", ЭтотОбъект);
...
Процедура УстановитьДоступность(Форма)
	...
	УстановитьДоступностьПоМаркировке(Форма, Форма.Объект.УказыватьПриМаркировкеПродукцииДляГИСМ);
КонецПроцедуры

&НаКлиентеНаСервереБезКонтекста
Процедура УстановитьДоступностьПоМаркировке(Форма, УказыватьПриМаркировкеПродукцииДляГИСМ)
...
&НаКлиенте
Процедура РазблокировкаРеквизитов(Знач РезультатЗакрытия, Знач ДополнительныеПараметры) Экспорт

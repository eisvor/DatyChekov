...
Процедура ХарактеристикаНачалоВыбора(Элемент, ДанныеВыбора, СтандартнаяОбработка)
	...
	Если ЗначениеЗаполнено(Запись.Владелец) Тогда
		...
		Если ОбработкаТабличнойЧастиТоварыВызовСервера.ИспользованиеХарактеристикИВладелецДляВыбора(Запись.Владелец, ВладелецХарактеристики) Тогда
...
Процедура УпаковкаНачалоВыбора(Элемент, ДанныеВыбора, СтандартнаяОбработка)
	...
	Если ЗначениеЗаполнено(Запись.Владелец) Тогда
		...
		ОбработкаТабличнойЧастиТоварыВызовСервера.СписокДляВыбораУпаковок(Запись.Владелец, ДанныеВыбора, Ложь);
	КонецЕсли;
...
Процедура ШтрихкодПриИзмененииСервер()
	...
	Запись.ТипШтрихкода = ПодключаемоеОборудованиеРТ.ТипШтрихкода(Запись.Штрихкод); 	

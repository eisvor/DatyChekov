...
// Читает данные из регистра за неделю.
//
// Параметры:
//	Магазин			- СправочникСсылка.Магазины - магазин для прочтения данных.
//	НачалоНедели	- Дата - дата начала недели.
//
// Возвращаемое значение:
//	ТаблицаЗначений - данные из регистра за неделю
//
...
Процедура ПриЗаполненииОграниченияДоступа(Ограничение) Экспорт
	...
	|ГДЕ
	|	ЗначениеРазрешено(ИнтервалРаботыМагазинов.Магазин)";

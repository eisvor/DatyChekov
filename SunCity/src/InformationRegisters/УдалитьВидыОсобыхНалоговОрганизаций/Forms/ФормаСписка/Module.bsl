...
Процедура ПриОткрытии(Отказ)
    ...
    ОценкаПроизводительностиРТКлиент.НачатьЗамер(
             Истина, "РегистрСведений.УдалитьВидыОсобыхНалоговОрганизаций.Форма.ФормаСписка.Открытие");
...
Процедура СписокВыбор(Элемент, ВыбраннаяСтрока, Поле, СтандартнаяОбработка)
    ...
    // &ЗамерПроизводительности
    ОценкаПроизводительностиРТКлиент.НачатьЗамер(
             Истина, "РегистрСведений.УдалитьВидыОсобыхНалоговОрганизаций.Форма.ФормаЗаписи.Открытие");

...
Процедура ХарактеристикаКомплектующейНачалоВыбора(Элемент, ДанныеВыбора, СтандартнаяОбработка)
	...
	Если ЗначениеЗаполнено(Запись.Комплектующая) Тогда
		...
		Если ОбработкаТабличнойЧастиТоварыВызовСервера.ИспользованиеХарактеристикИВладелецДляВыбора(Запись.Комплектующая, ВладелецХарактеристики) Тогда
...
Процедура УпаковкаНачалоВыбора(Элемент, ДанныеВыбора, СтандартнаяОбработка)
	...
	Если ЗначениеЗаполнено(Запись.Комплектующая) Тогда
		...
		ОбработкаТабличнойЧастиТоварыВызовСервера.СписокДляВыбораУпаковок(Запись.Комплектующая, ДанныеВыбора, Ложь);
	КонецЕсли;
...
Процедура УстановитьДоступностьХарактеристикУпаковки(ИмяПоля = "");
	...
	Если ИмяПоля = "" ИЛИ ИмяПоля = "Комплектующая" Тогда
		...
		РеквизитыКомплектующей = ОбщегоНазначения.ЗначенияРеквизитовОбъекта(Запись.Комплектующая, "ЕдиницаИзмерения, НаборУпаковок");
		УпаковкиКомплектующейНеИспользуются = Не ЗначениеЗаполнено(РеквизитыКомплектующей.НаборУпаковок);
		
		Элементы.Упаковка.ПодсказкаВвода = РеквизитыКомплектующей.ЕдиницаИзмерения;
		Элементы.Упаковка.ТолькоПросмотр =НЕ ЗначениеЗаполнено(Запись.Комплектующая) ИЛИ УпаковкиКомплектующейНеИспользуются;

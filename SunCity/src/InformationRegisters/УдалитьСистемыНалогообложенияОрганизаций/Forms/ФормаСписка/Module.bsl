...
Процедура ПриОткрытии(Отказ)
    ...
    ОценкаПроизводительностиРТКлиент.НачатьЗамер(
             Истина, "РегистрСведений.УдалитьСистемыНалогообложенияОрганизаций.Форма.ФормаСписка.Открытие");
...
Процедура СписокВыбор(Элемент, ВыбраннаяСтрока, Поле, СтандартнаяОбработка)
    ...
    // &ЗамерПроизводительности
    ОценкаПроизводительностиРТКлиент.НачатьЗамер(
             Истина, "РегистрСведений.УдалитьСистемыНалогообложенияОрганизаций.Форма.ФормаЗаписи.Открытие");

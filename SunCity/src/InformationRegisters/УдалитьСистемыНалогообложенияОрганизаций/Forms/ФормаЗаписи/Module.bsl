...
Процедура ОбработкаПроверкиЗаполненияНаСервере(Отказ, ПроверяемыеРеквизиты)
	...
	ИспользуетсяУСН = Запись.СистемаНалогообложения = ПредопределенноеЗначение("Перечисление.УдалитьСистемыНалогообложения.Упрощенная");
...
Процедура УстановитьДоступностьИЗначениеОбъектаНалогообложения()
	...
	Если не ИспользуетсяУСН и не Запись.ОбъектНалогообложения = ПредопределенноеЗначение("Перечисление.УдалитьСистемыНалогообложения.ПустаяСсылка") Тогда
		Запись.ОбъектНалогообложения = ПредопределенноеЗначение("Перечисление.УдалитьСистемыНалогообложения.ПустаяСсылка");
	КонецЕсли;
...
Процедура УстановитьУсловноеОформление()
	...
	ОтборЭлемента.ПравоеЗначение = Перечисления.УдалитьСистемыНалогообложения.Упрощенная;

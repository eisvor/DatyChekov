...
//
// Параметры:
//	Магазин			- СправочникСсылка.Магазины - магазин для получения графика.
//	НомерГода		- Число - Номер года, за который необходимо прочитать календарь.
//
...
//
// Параметры:
//	Магазин		    - СправочникСсылка.Магазины - магазин для записи графика.
//	НомерГода	    - Число - Номер года, за который необходимо записать календарь.
//	ТаблицаРегистра - СписокЗначений - список значений, в котором указано, какие даты входят в календарь.
//
...
//
// Параметры:
//  ЗаписьРегистра - РегистрСведенийМенеджерЗаписи.ГрафикиРаботыМагазинов - запись регистра сведений.
//

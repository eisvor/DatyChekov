...
Процедура ПриСозданииНаСервере(Отказ, СтандартнаяОбработка)
	...
	ПравоДоступаНаСоздание = ПравоДоступа("Добавление", Метаданные.Документы.ПриходныйКассовыйОрдер);
	Элементы.ГруппаСоздать.Видимость                             = ПравоДоступаНаСоздание;
	Элементы.ДенежныеСредстваКПоступлениюПринятьОплату.Видимость = ПравоДоступаНаСоздание;

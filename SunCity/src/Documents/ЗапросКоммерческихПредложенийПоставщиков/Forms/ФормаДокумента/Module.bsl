...
Процедура ПересчитатьЦеныВДокументе()
	...
	Для Каждого Источник Из Объект.ВыбранныеИсточники Цикл
		...
		Источник.СуммаВВалютеЗапроса = Сумма;
		Источник.ЦенаВВалютеЗапроса = Источник.ЦенаПоставщика;
...
Процедура ЗаполнитьКЗаказуПоступившиеПредложения()
	...
	Для Каждого Предложение Из ПоступившиеПредложения Цикл
		...
		СуммаМинимум  = Предложение.СуммаМинимум;
		СуммаМаксимум = Предложение.СуммаМаксимум;
	...
	Для Каждого СтрокаКоллекции Из ТаблицаШапка Цикл
		...
		Иначе
			...
			НоваяСтрока.СуммаКЗаказу = СуммаКЗаказу;
...
Функция ПолучитьТоварыДляЗаказа(АдресКэшаВыбранныхИсточников)
	...
	Для Каждого Источник Из Объект.ВыбранныеИсточники Цикл
		...
		НоваяСтрока.Вставить("КодЕдиницыИзмерения"                  , ОбщегоНазначения.ЗначениеРеквизитаОбъекта(Источник.ЕдиницаИзмеренияПоставщика.ЕдиницаИзмерения, "Код"));

...
Процедура ПриЗагрузкеДанныхИзНастроекНаСервере(Настройки)
	...
	Если НЕ ПолучитьФункциональнуюОпцию("КассоваяКнигаПоМагазинам") Тогда
...
Процедура СписокВыбор(Элемент, ВыбраннаяСтрока, Поле, СтандартнаяОбработка)
	...
	ОценкаПроизводительностиРТКлиент.НачатьЗамер(
		         Истина, "Документ.КассоваяКнига.Форма.ФормаДокумента.Открытие");
...
Процедура ПриОткрытии(Отказ)
    ...
    // &ЗамерПроизводительности
    ОценкаПроизводительностиРТКлиент.НачатьЗамер(
             Истина, "Документ.КассоваяКнига.Форма.ФормаСпискаДокументов.Открытие");
...
Процедура СписокПередНачаломДобавления(Элемент, Отказ, Копирование, Родитель, Группа, Параметр)
    ...
    // &ЗамерПроизводительности
    ОценкаПроизводительностиРТКлиент.НачатьЗамер(
             Истина, "Документ.КассоваяКнига.Форма.ФормаДокумента.СозданиеНового");

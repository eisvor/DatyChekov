...
Процедура ИнициализироватьДокумент(ДанныеЗаполнения = Неопределено)
	...
	Если ТипЗнч(ДанныеЗаполнения) <> Тип("Структура") Или Не ДанныеЗаполнения.Свойство("Организация") Тогда
		Организация = ЗначениеНастроекПовтИсп.ОрганизацияПоУмолчанию(Организация);
	КонецЕсли;
	...
	Если ТипЗнч(ДанныеЗаполнения) = Тип("Структура")
		...
		СФВыданный = Неопределено;
		ДанныеЗаполнения.Свойство("СФВыданный", СФВыданный);
		
		Если Не ЗначениеЗаполнено(СФВыданный) Тогда
			СФВыданный = ПродажиВызовСервера.СчетФактураДокумента(
			ДанныеЗаполнения.ДокументОснование,
			ОбщегоНазначения.ЗначениеРеквизитаОбъекта(ДанныеЗаполнения.ДокументОснование,"Организация"));
		КонецЕсли;
		
		РеквизитыСФВыданный = ОбщегоНазначения.ЗначенияРеквизитовОбъекта(СФВыданный, "Номер, ДатаВыставления");
		Номер = РеквизитыСФВыданный.Номер;
		ДатаСоставления = РеквизитыСФВыданный.ДатаВыставления;
	КонецЕсли; 
	
	Если ТипЗнч(ДанныеЗаполнения) = Тип("Структура")
		И ДанныеЗаполнения.Свойство("СчетФактураОснование") Тогда
		СчетФактураОснование = ДанныеЗаполнения.СчетФактураОснование;
	КонецЕсли;

...
Процедура ВыполнитьРегламентноеЗаданиеРасчетСебестоимости() Экспорт
	...
	Если ОбменДаннымиРТ.ЭтоПодчиненныйУзелПоМагазину() ИЛИ ОбменДаннымиРТ.ЭтоПодчиненныйУзелПоРабочемуМесту() Тогда
		Возврат;
	КонецЕсли;
...
Процедура ВыполнитьРасчетСебестоимости(Дата, МассивМагазинов)
	...
	ИмяСобытияЖурналаРегистрации = НСтр("ru = 'Обновление стоимости товаров'", ОбщегоНазначения.КодОсновногоЯзыка());

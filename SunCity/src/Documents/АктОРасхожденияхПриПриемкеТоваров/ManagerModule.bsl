...
//
// Параметры:
//	Объект - ДокументОбъект.АктОРасхожденияхПриПриемкеТоваров, ДанныеФормыСтруктура - документ, для которого нужно сформировать параметры проверки.
//
					...
					Для Каждого СтрокаОснования Из СтрокиОснования Цикл
						...
						Если ВосстановитьПолучателяПоОтправителю Тогда
							...
							Если СвернутьПоставщикаУПолучателя Тогда
								...
								НоваяСтрокаПолучателя.Договор = Справочники.ДоговорыКонтрагентов.ПустаяСсылка();
							КонецЕсли;
						КонецЕсли;
...
//
// Параметры:
//  ПеремещениеСсылка - ДокументСсылка.ПеремещениеТоваров - акт расхождений по перемещению.
//

...
Процедура ИзменитьКоманднуюПанельДокумента(ТекущиеДанные = Неопределено, МножественныйВыбор = Ложь)
	...
	Иначе
		Если Не ТекущиеДанные = Неопределено Тогда
			...
			МожноПодтвердить = Не МожноОбновить;
			МожноОтклонить   = Не МожноОбновить; 
	...
	ОбщегоНазначенияИСМПТККлиентСервер.УстановитьСвойствоЭлементаФормы(Элементы, "СписокДокументУведомлениеОВвозеИзЕАЭСИСЦЭДМОбновить", 
																"Видимость", УПользователяЕстьНастройкаОбмена И МожноОбновить);
	ОбщегоНазначенияИСМПТККлиентСервер.УстановитьСвойствоЭлементаФормы(Элементы, "СписокДокументУведомлениеОВвозеИзЕАЭСИСЦЭДМОтправить", 
																"Видимость", УПользователяЕстьНастройкаОбмена И МожноОтправить);
	
	ОбщегоНазначенияИСМПТККлиентСервер.УстановитьСвойствоЭлементаФормы(Элементы, "СписокГруппаДопКоманды",
																"Видимость", УПользователяЕстьНастройкаОбмена И МожноОбновить);

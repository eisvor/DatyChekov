...
Процедура ИнициализироватьДокумент(ДанныеЗаполнения = Неопределено)
	...
	СкладОтправитель = ЗначениеНастроекПовтИсп.СкладПоступленияПоУмолчанию(
		Магазин,,
		СкладОтправитель,
		Ответственный);
	
	СкладПолучатель  = ЗначениеНастроекПовтИсп.СкладПродажиПоУмолчанию(Магазин,,СкладПолучатель, Ответственный);
	...
	Если ТипЗнч(ДанныеЗаполнения) = Тип("Структура") Тогда
		Если ДанныеЗаполнения.Свойство("Магазин")
			...
			СкладПолучатель  = ЗначениеНастроекПовтИсп.СкладПродажиПоУмолчанию(
				ДанныеЗаполнения.Магазин,
				,
				СкладПолучатель,
				Ответственный);

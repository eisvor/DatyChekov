...
Процедура ПриСозданииНаСервере(Отказ, СтандартнаяОбработка)
	...
	Если Объект.Ссылка.Пустая() И ЗначениеЗаполнено(Объект.ОбъектПланирования) Тогда
		ДоступностьПравилаЦенообразования = ОбщегоНазначенияРТВызовСервера.РеквизитДоступен(
...
Процедура ОбъектПланированияПриИзмененииСервер()
	...
	Если НЕ ДоступностьПравилаЦенообразования Тогда
		...
		ОбщегоНазначения.СообщитьПользователю(ТекстСообщения, , "ОбъектПланирования");
...
Функция ТоварыЗаполнены()
	...
	Если Объект.Товары.Количество() = 0 Тогда
		...
		ОбщегоНазначенияКлиент.СообщитьПользователю(ТекстПредупреждения, , "Товары", "Объект");
		Результат = Ложь;

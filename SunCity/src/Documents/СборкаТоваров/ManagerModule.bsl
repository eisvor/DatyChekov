...
//  Структура - состав полей определяется требованиями функции ОбработкаТабличнойЧастиСервер.ЗаполнитьСтатусыУказанияСерий.
//
...
Процедура ИнициализироватьДанныеДокумента(ДокументСсылка, ДополнительныеСвойства) Экспорт
	...
	МассивАвтономныйУчет = Новый Массив;
	МассивАвтономныйУчет.Добавить(Перечисления.СпособыУчетаСебестоимости.АвтономныйУчет);
	
	Запрос.УстановитьПараметр("МассивАвтономныйУчет", МассивАвтономныйУчет);
	...
	|				&Период,
	|				Магазин = &ПустойМагазин И НЕ Регистратор = &Ссылка
	|					И (Номенклатура, Характеристика) В
	|						(ВЫБРАТЬ РАЗЛИЧНЫЕ
	|							ВтТаблицаКомплекты.Номенклатура,
	|							ВтТаблицаКомплекты.Характеристика
	...
	|ГДЕ &ИспользоватьУчетСебестоимости И &СпособУчета В (&МассивАвтономныйУчет)
	|	И &СборкаКомплектующих;
	|
	|////////////////////////////////////////////////////////////////////////////////
	...
	|ИЗ Шапка КАК Шапка,
	|	(ВЫБРАТЬ ПЕРВЫЕ 1
	|	СебестоимостьКомплекта.Период КАК Период,
	|	СебестоимостьКомплекта.Номенклатура КАК Номенклатура,
	|	СебестоимостьКомплекта.Характеристика КАК Характеристика,
	|	СебестоимостьКомплекта.Цена КАК Себестоимость
	|ИЗ
	|	РегистрСведений.СебестоимостьНоменклатуры.СрезПоследних(
	|			,
	|			(Магазин = &Магазин
	...
	|					ИЗ
	|						Шапка КАК Шапка)) КАК СебестоимостьКомплекта
	|УПОРЯДОЧИТЬ ПО
	|	Период УБЫВ) КАК СебестоимостьКомплекта	
	|	ГДЕ &ИспользоватьУчетСебестоимости И &СпособУчета В (&МассивАвтономныйУчет)
	|		И НЕ &СборкаКомплектующих
	|;
	|////////////////////////////////////////////////////////////////////////////////
	...
	|	&СборкаКомплектующих
	|	И &ФормироватьДвижения
	|	И &СпособУчета В (&МассивАвтономныйУчет)
	|
	|ОБЪЕДИНИТЬ ВСЕ
	|
	|	ВЫБРАТЬ

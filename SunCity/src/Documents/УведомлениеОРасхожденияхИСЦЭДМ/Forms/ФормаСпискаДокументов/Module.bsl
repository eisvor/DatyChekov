...
Процедура ПриСозданииНаСервере(Отказ, СтандартнаяОбработка)
	...
	СписокНаправленийУведомлений.Добавить(Перечисления.НаправленияДокументовИСМПТК.Входящий,  НСтр("ru = 'Уведомления о расхождениях (входящие) (ИС ЦЭДМ)'"));
	СписокНаправленийУведомлений.Добавить(Перечисления.НаправленияДокументовИСМПТК.Исходящий, НСтр("ru = 'Уведомления о расхождениях (исходящие) (ИС ЦЭДМ)'"));
...
Процедура ОткрытьСписокУведомлений(НаправлениеУведомление)
	...
	Если НаправлениеУведомление = ПредопределенноеЗначение("Перечисление.НаправленияДокументовИСМПТК.Входящий") Тогда
		ОткрытьФорму("Документ.УведомлениеОРасхожденияхИСЦЭДМ.Форма.ФормаСпискаВходящих", ПараметрыФормы);
	Иначе
		ОткрытьФорму("Документ.УведомлениеОРасхожденияхИСЦЭДМ.Форма.ФормаСпискаИсходящих", ПараметрыФормы);
	КонецЕсли;

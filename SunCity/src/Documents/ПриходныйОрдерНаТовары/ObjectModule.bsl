...
//
// Параметры:
//  ВидЗаполнения - Строка - вид заполнения табличной части.
//
...
Процедура ОбработкаЗаполнения(ДанныеЗаполнения, СтандартнаяОбработка)
	...
	Иначе
		...
		ТекстСообщения = НСтр("ru='Приходный ордер можно вводить только на основании распоряжения на поступление товаров.
								  |Склад -> Приемка -> Распоряжение на приемку -> Выполнить приемку.'");
...
Процедура ЗаполнитьПоОснованию()
	...
	ЗначенияРеквизитов = ОбщегоНазначенияРТ.ЗначенияРеквизитовОбъекта(ДокументОснование, Реквизиты);

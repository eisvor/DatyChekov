...
// Возвращает табель строки по сотруднику.
// 
// Параметры:
//  ДанныеОВремени - ТаблицаЗначений - общий табель.
//  НомерСтрокиСотрудник - Число - номер сотрудника.
//
// Возвращаемое значение:
//  ТаблицаЗначений - табель по сотруднику.
//
...
// Возвращает обозначения видов времени.
// 
// Параметры:
//  СоответствиеОбозначенийВидамВремени - Соответствие - соответствие обозначений видов времени.
//
// Возвращаемое значение:
//  Соответствие - обозначения видов времени.
//
...
// Данные о времени сотрудников.
// 
// Параметры:
//  ДанныеТабеля - Структура - данные табеля.
//  СписокСотрудников - Массив - список сотрудников.
//
// Возвращаемое значение:
//  ВыборкаИзРезультатаЗапроса - данные о времени сотрудников.
//
...
Процедура Печать(МассивОбъектов, ПараметрыПечати, КоллекцияПечатныхФорм, ОбъектыПечати, ПараметрыВывода) Экспорт
	...
	Если УправлениеПечатью.НужноПечататьМакет(КоллекцияПечатныхФорм,
		...
		УправлениеПечатью.ВывестиТабличныйДокументВКоллекцию(КоллекцияПечатныхФорм,
			...
			Нстр("ru='Табель учета рабочего времени (Т-13)'"),

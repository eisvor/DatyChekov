...
Процедура ПослеЗаписиНаСервере(ТекущийОбъект, ПараметрыЗаписи)
	...
	Элементы.СтраницаОписание.Картинка = ОбщегоНазначенияРТ.КартинкаКомментария(Объект.Описание);
КонецПроцедуры
...
Процедура ПриСозданииЧтенииНаСервере()
	...
	Элементы.СтраницаОписание.Картинка = ОбщегоНазначенияРТ.КартинкаКомментария(Объект.Описание);
	Элементы.СтраницаКомментарий.Картинка = ОбщегоНазначенияРТ.КартинкаКомментария(Объект.Комментарий);

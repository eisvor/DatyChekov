...
//
// Параметры:
//  ПроверяемыйОбъектПланирования - СправочникСсылка.ФорматыМагазинов - объект планирования.
//  НаДату - Дата - дата проверки.
//  ВызывающийДокумент - ДокументСсылка - документ основание.
//
// Возвращаемое значение:
//  Булево - признак существования плана.
//

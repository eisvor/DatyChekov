...
Процедура СписокВыбор(Элемент, ВыбраннаяСтрока, Поле, СтандартнаяОбработка)
    ...
    ОценкаПроизводительностиРТКлиент.НачатьЗамер(
             Истина, "Документ.УстановкаКвотАссортимента.Форма.ФормаДокумента.Открытие");
...
Процедура ПриОткрытии(Отказ)
    ...
    // &ЗамерПроизводительности
    ОценкаПроизводительностиРТКлиент.НачатьЗамер(
             Истина, "Документ.УстановкаКвотАссортимента.Форма.ФормаСписка.Открытие");
...
Процедура СписокПередНачаломДобавления(Элемент, Отказ, Копирование, Родитель, Группа, Параметр)
    ...
    // &ЗамерПроизводительности
	ОценкаПроизводительностиРТКлиент.НачатьЗамер(
		     Истина, "Документ.УстановкаКвотАссортимента.Форма.ФормаДокумента.СозданиеНового");

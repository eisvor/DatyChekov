...
Процедура ПолучитьТекущийВес()
	...
	ОповещениеЗавершенияВзвешивания = Новый ОписаниеОповещения("ПолучитьВесСЭлектронныхВесовЗавершение",
		ЭтотОбъект);
	МенеджерОборудованияКлиент.НачатьПолученияВесаСЭлектронныхВесов(ОповещениеЗавершенияВзвешивания,
		УникальныйИдентификатор, ТекущиеЭлектронныеВесы, Ложь);
...
Процедура ТарироватьВесы(ЗначениеВесаТары, ЭтоСбросЗначения = Ложь)
	...
	ПараметрыОперации = МенеджерОборудованияКлиентСервер.ПараметрыОперацииЭлектронныеВесы(ЗначениеВесаТары);
	МенеджерОборудованияКлиент.НачатьУстановкуВесаТары(ОповещениеОбОкончанииУстановкиВесаТары,

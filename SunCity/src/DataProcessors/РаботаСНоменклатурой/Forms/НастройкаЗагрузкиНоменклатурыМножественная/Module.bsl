...
&НаКлиенте
Процедура ВидыНоменклатурыВидНоменклатурыНачалоВыбора(Элемент, ДанныеВыбора, СтандартнаяОбработка)
	
	// +РТ
	// При выборе вида из формы Загрузка номенклатуры отображаем элементы не помеченные на удаление.
	СтандартнаяОбработка = Ложь;
	ПараметрыОтбора      = Новый Структура;
	ПараметрыОтбора.Вставить("ПометкаУдаления", Ложь);
	ОткрытьФорму("Справочник.ВидыНоменклатуры.ФормаВыбора", Новый Структура("Отбор", ПараметрыОтбора), Элементы.ВидыНоменклатурыВидНоменклатуры);
	// -РТ

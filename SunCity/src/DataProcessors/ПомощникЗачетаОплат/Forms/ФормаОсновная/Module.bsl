...
Процедура ТаблицаДокументовСуммаКОплатеПриИзменении(Элемент)
	...
	Если КонтролироватьПревышение
		...
		ТекстСообщения = НСтр("ru = 'Превышена на %1 тг. сумма оплаты задолженности по документу %2.
	...
	Если Отказ Тогда
		...
		ТекстСообщения = НСтр("ru = 'Превышена на %1 тг. сумма аванса по документу %2.
									|Сумма оплаты скорректирована.'");

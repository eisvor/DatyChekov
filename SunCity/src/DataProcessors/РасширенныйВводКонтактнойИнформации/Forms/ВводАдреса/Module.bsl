...
Процедура ПриСозданииНаСервере(Отказ, СтандартнаяОбработка)
	...
	Элементы.СтраницаМуниципальныйАдрес.Видимость = Ложь;
	Элементы.СтраницаАдминистративноТерриториальныйАдрес.Видимость = Ложь;
	Элементы.СтраницаАдресВСвободнойФорме.Видимость = Ложь;

...
Процедура ПрименитьЦены(Команда)
	...
	Если НЕ ЗначениеЗаполнено(Объект.Ответственный) Тогда
		...
		ОбщегоНазначенияКлиент.СообщитьПользователю(ТекстОшибки,,"Ответственный","Объект",Отказ);
	...
	Если ТаблицаЦен.ПолучитьЭлементы().Количество() = 0 Тогда
		...
		ОбщегоНазначенияКлиент.СообщитьПользователю(ТекстОшибки,,"ТаблицаЦен",,Отказ);
...
Функция ПроверкаПередЗаполнениемНаКлиенте()
	...
	Если НЕ ЗначениеЗаполнено(Объект.ОбъектЦенообразования) Тогда
		...
		ОбщегоНазначенияКлиент.СообщитьПользователю(ТекстОшибки,,"Объект.ОбъектЦенообразования",,Отказ);
	...
	Если НЕ ЗначениеЗаполнено(Объект.ДатаАнализа) Тогда
		...
		ОбщегоНазначенияКлиент.СообщитьПользователю(ТекстОшибки,,"Объект.ДатаАнализа",,Отказ);
...
Функция ПоместитьВоВременноеХранилищеСервер()
	...
	ТаблицаЦенЗначение.Колонки.Добавить("НомерСтроки", ОбщегоНазначенияРТКлиентСервер.ОписаниеТиповЧисла(15, 0));
	...
	ТаблицаЦенЗначение.Колонки.Добавить("Цена", ОбщегоНазначенияРТКлиентСервер.ОписаниеТиповЧисла(15, 2));

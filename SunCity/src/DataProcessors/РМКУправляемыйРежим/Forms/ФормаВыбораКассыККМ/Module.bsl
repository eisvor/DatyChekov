...
Процедура ПриСозданииНаСервере(Отказ, СтандартнаяОбработка)
	...
	Если Параметры.Свойство("ТекущаяКассаККМ") И ЗначениеЗаполнено(Параметры.ТекущаяКассаККМ) Тогда
		НайденныеСтроки = Список.НайтиСтроки(Новый Структура("Касса", Параметры.ТекущаяКассаККМ));

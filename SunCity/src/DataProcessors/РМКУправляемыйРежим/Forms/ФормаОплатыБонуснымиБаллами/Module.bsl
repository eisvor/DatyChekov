...
Процедура ПриСозданииНаСервере(Отказ, СтандартнаяОбработка)
	...
	Если Параметры.Свойство("БонуснаяПрограммаЛояльности") Тогда
	...
	ИначеЕсли МаксимальнаяСуммаОплаты <= 0 Тогда
		...
		Элементы.КомандаEnter.Доступность = Ложь;
	Иначе
		СтрокаМаксимальнойСуммы = НСтр("ru = 'Максимальная сумма оплаты:'") + Символы.ПС + НСтр("ru = '%1 тг. (%2 бонусных баллов)'");
...
Процедура СуммаОплатыПриИзменении(Элемент = Неопределено)
	...
	Если СуммаОплаты > МаксимальнаяСуммаОплаты Тогда
		СтрокаПредупреждения = НСтр("ru = 'Максимальная сумма оплаты %1 тг.'");
		СуммаОплаты = МаксимальнаяСуммаОплаты;
		ПервыйВвод = Истина;
	КонецЕсли;

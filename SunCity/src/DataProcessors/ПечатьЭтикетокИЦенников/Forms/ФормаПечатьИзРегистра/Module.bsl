...
Процедура ЗаполнитьТаблицуПакетовЗагрузки()
	...
	Для Каждого Строка Из ТаблицаПакетовЗагрузки Цикл
		...
		|	ЦенникиКПечати.ШтрихАвтопроверки КАК ШтрихАвтопроверки
		|ИЗ
		|	РегистрСведений.ЦенникиКПечати КАК ЦенникиКПечати
		|ГДЕ
		...
		|	ЦенникиКПечати.ШтрихАвтопроверки");
		...
		Пока Выборка.Следующий() Цикл
			...
			НовыйТовар.ШтрихАвтопроверки    = Выборка.ШтрихАвтопроверки;
...
Процедура ЗаполнитьТаблицуТоваровПоПакету(НомерПакета)
	...
	Для Каждого Строка Из НайденныеСтроки Цикл
		...
		Иначе
			...
			НоменклатураТоваров.ШтрихАвтопроверки    = НайденныеСтроки[Индекс].ШтрихАвтопроверки;
		КонецЕсли;
		Индекс = Индекс + 1;
...
Процедура ПометитьЗаписьКУдалению(ИДЦенника)
	...
	ЭлементБлокировки = Блокировка.Добавить("РегистрыСведений.ЦенникиКПечати");

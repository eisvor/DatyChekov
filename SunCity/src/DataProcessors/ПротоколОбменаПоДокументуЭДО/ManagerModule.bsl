...
Функция ДанныеПротоколовОбменаПоДокументам(ЭлектронныеДокументы)
	...
	СостоянияДокументов = ЭлектронныеДокументыЭДО.СостоянияДокументов(ЭлектронныеДокументы);
	...
	Пока ВыборкаДанныеЭД.Следующий() Цикл
		...
		СостояниеДокумента = СостоянияДокументов.Получить(ЭлектронныйДокумент);

...
Процедура ЗаписьВРегистр(МагазинЗаписи = Неопределено)
	...
	Если Режим = "РаспределениеПоступления" Тогда
		...
		РегистрыСведений.УдалитьРаспределениеПоступлений.ЗаписатьДанныеВРегистр(ТаблицаЗаписи);
		
	ИначеЕсли Режим = "РаспределениеРеализацииУслуг" Тогда
		
		ТаблицаЗаписи.ЗаполнитьЗначения(?(МагазинЗаписи = Неопределено, Объект.Магазин, МагазинЗаписи) ,"Магазин");
		РегистрыСведений.УдалитьРаспределениеПродажУслугПоОрганизациям.ЗаписатьДанныеВРегистр(ТаблицаЗаписи);
	Иначе
		...
		ТаблицаЗаписи.ЗаполнитьЗначения(?(МагазинЗаписи = Неопределено, Объект.Магазин, МагазинЗаписи) ,"Магазин");
		РегистрыСведений.УдалитьРаспределениеПродаж.ЗаписатьДанныеВРегистр(ТаблицаЗаписи);
...
Функция НеобходимыеДанныеЗаполнены()
	...
	Иначе
		...
		Если НЕ ЗначениеЗаполнено(Объект.Магазин) Тогда
			...
			ОбщегоНазначенияКлиент.СообщитьПользователю(ТекстСообщения,,"Объект.Магазин",,ЕстьОшибки);

...
Процедура ПриСозданииНаСервере(Отказ, СтандартнаяОбработка)
	...
	МассивКатегорийНоменклатуры = ПодборТоваровВызовСервера.ОбщиеСвойстваНоменклатуры();
	...
	МассивСтруктурСвойствИЗначений = ПодборТоваровВызовСервера.СвойстваВидаНоменклатуры(Параметры.ВидНоменклатуры);
				...
				Для Каждого Эл Из Массив Цикл
					...
					Если Эл.Свойство = СтруктураЗначенияСвойств.Свойство Тогда
						...
						Если Эл.ТипСвойства = 1 Тогда
							...
							Для каждого РеквизитФормы Из Эл.РеквизитыФормы Цикл
								
								Если СтруктураЗначенияСвойств.Значение.НайтиПоЗначению(РеквизитФормы.Значение) <> Неопределено Тогда
									ЭтаФорма[РеквизитФормы.ИмяРеквизитаФормы] = Истина;
								КонецЕсли;
...
Процедура Применить(Команда)
	...
	Для каждого Свойство Из ОписаниеФормы.Массив Цикл
		...
		// Конвертируем флажки в список значений для отбора.

...
Процедура ПриЧтенииНаСервере(ТекущийОбъект)
	...
	Если Объект.ВариантНастройки = "ОбменМК" Тогда
		
		Если Объект.Магазины.Количество() = 1 Тогда
			РозничныйМагазин = Объект.Магазины[0].Магазин;
		КонецЕсли;
...
Процедура ОбработкаПроверкиЗаполненияНаСервере(Отказ, ПроверяемыеРеквизиты)
	...
	ОбщегоНазначенияКлиентСервер.УдалитьЗначениеИзМассива(ПроверяемыеРеквизиты, "РозничныйМагазин");
	
	Если Объект.ВариантНастройки = "ОбменМК" Тогда
		
		Если РозничныйМагазин.Пустая() Тогда
...
&НаКлиенте
Процедура РозничныйМагазинНачалоВыбора(Элемент, ДанныеВыбора, СтандартнаяОбработка)
	
	МагазиныМагазинНачалоВыбора(Элемент, ДанныеВыбора, СтандартнаяОбработка);
	
КонецПроцедуры

&НаКлиенте
Процедура РозничныйМагазинПриИзменении(Элемент)
	
	Объект.Магазины.Очистить();
	
	Если НЕ РозничныйМагазин.Пустая() Тогда
		
		Объект.Магазины.Добавить().Магазин = РозничныйМагазин;
		
	КонецЕсли;
	
	РозничныйМагазинПриИзмененииСервер();
...
Процедура УстановитьВидимостьНаСервере()
	...
	ОбщегоНазначенияКлиентСервер.УстановитьСвойствоЭлементаФормы(
		...
		"Видимость",
		Объект.ВариантНастройки = "ОбменКасса" ИЛИ Объект.ВариантНастройки = "ОбменМК");
	
	Если Объект.ВариантНастройки = "ОбменКасса" ИЛИ Объект.ВариантНастройки = "ОбменМК" Тогда
		...
		Если Объект.ВариантНастройки = "ОбменМК" Тогда
			...
			Элементы.ГруппаВыгрузкаКассаРозничныеСклады.Заголовок = НСтр("ru = 'Розничный магазин'");
			Элементы.СтраницыВыгрузкаКассаРозничныеСклады.ТекущаяСтраница = Элементы.СтраницаРозничныйМагазин;
			
			ОбщегоНазначенияКлиентСервер.УстановитьСвойствоЭлементаФормы(
				Элементы,
				"РозничныйМагазинПравилоЦенообразованияВидЦен",
				"Видимость",
				НЕ РозничныйМагазин.Пустая());
...
&НаСервере
Процедура РозничныйМагазинПриИзмененииСервер()

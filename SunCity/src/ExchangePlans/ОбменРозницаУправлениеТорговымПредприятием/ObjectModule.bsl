...
Процедура ПередЗаписью(Отказ)
	...
	Иначе
		Если ПометкаУдаления Тогда
			...
			|	УзлыОбмена.Ссылка
			|ИЗ
			|	ПланОбмена.ОбменРозницаУправлениеТорговымПредприятием КАК УзлыОбмена
			|ГДЕ
			|	УзлыОбмена.Ссылка <> &ЭтотУзел
			|	И УзлыОбмена.Ссылка <> &Ссылка
			|	И (НЕ УзлыОбмена.ПометкаУдаления)");
			Запрос.УстановитьПараметр("ЭтотУзел", ПланыОбмена.ОбменРозницаУправлениеТорговымПредприятием.ЭтотУзел());

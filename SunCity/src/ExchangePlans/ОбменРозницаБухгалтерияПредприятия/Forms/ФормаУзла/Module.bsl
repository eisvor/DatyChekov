...
Процедура ПриСозданииНаСервере(Отказ, СтандартнаяОбработка)
	...
	ИмяУзла = МодульОбменДанными.ПолучитьИмяПланаОбмена(Объект.Ссылка);
	
	Если МодульОбменДанными.ПолучитьЭтотУзелПланаОбмена(ИмяУзла) = Объект.Ссылка Тогда
...
Процедура ПослеЗаписиНаСервере(ТекущийОбъект, ПараметрыЗаписи)
	...
	Если НЕ МодульОбменДанными.ПолучитьЭтотУзелПланаОбмена(ИмяУзла) = Объект.Ссылка Тогда
		ЗапретРедактированияРеквизитовОбъектов.ЗаблокироватьРеквизиты(ЭтаФорма);
	КонецЕсли;
...
Функция ЭтоПредопределенныйУзелПланаОбмена()
	...
	Возврат МодульОбменДанными.ПолучитьЭтотУзелПланаОбмена(ИмяУзла) = Объект.Ссылка;

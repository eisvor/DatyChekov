...
// Дополняет профиль ролями ГИСМ для выполнения базовых функций работы с РТ
//
// Параметры:
//  ОписаниеПрофиля - Структура - описание поставляемого профиля 
//                    (см. УправлениеДоступом.НовоеОписаниеПрофиляГруппДоступа)
//
Процедура ДополнитьПрофильОбязательнымиРолямиГИСМ(ОписаниеПрофиля)Экспорт
...
// Дополняет профиль ролями ГИСМ для чтения и просмотра документов и журналов ГИСМ
//
// Параметры:
//  ОписаниеПрофиля - Структура - описание поставляемого профиля 
//                    (см. УправлениеДоступом.НовоеОписаниеПрофиляГруппДоступа)
//
Процедура ДополнитьПрофильПравамиЧтенияДокументовГИСМ(ОписаниеПрофиля)Экспорт
...
// Дополняет профиль ролями ГИСМ для чтения и просмотра справочников и регистров ГИСМ
//
// Параметры:
//  ОписаниеПрофиля - Структура - описание поставляемого профиля 
//                    (см. УправлениеДоступом.НовоеОписаниеПрофиляГруппДоступа)
//
Процедура ДополнитьПрофильПравамиЧтенияСправочнойИнформацииГИСМ(ОписаниеПрофиля)Экспорт
...
// Дополняет профиль ролями ГИСМ для создания и изменения настроек ГИСМ
//
// Параметры:
//  ОписаниеПрофиля - Структура - описание поставляемого профиля 
//                    (см. УправлениеДоступом.НовоеОписаниеПрофиляГруппДоступа)
//
Процедура ДополнитьПрофильПравамиНастройкиГИСМ(ОписаниеПрофиля)Экспорт
	
	ОписаниеПрофиля.Роли.Добавить("НастройкиОбменаГИСМ");
	
КонецПроцедуры

// Дополняет профиль ролями ГИСМ для создания документов и выполнения обменов ГИСМ
//
// Параметры:
//  ОписаниеПрофиля - Структура - описание поставляемого профиля 
//                    (см. УправлениеДоступом.НовоеОписаниеПрофиляГруппДоступа)
//
Процедура ДополнитьПрофильПравамиОбменаГИСМ(ОписаниеПрофиля)Экспорт
...
// Дополняет профиль ролями ГИСМ для добавления и изменения справочников и регистров ГИСМ
//
// Параметры:
//  ОписаниеПрофиля - Структура - описание поставляемого профиля 
//                    (см. УправлениеДоступом.НовоеОписаниеПрофиляГруппДоступа)
//
Процедура ДополнитьПрофильПравамиИзмененияСправочнойИнформацииГИСМ(ОписаниеПрофиля)Экспорт
...
// Дополняет профиль ролями ГИСМ для работы с отчетами ГИСМ
//
// Параметры:
//  ОписаниеПрофиля - Структура - описание поставляемого профиля 
//                    (см. УправлениеДоступом.НовоеОписаниеПрофиляГруппДоступа)
//
Процедура ДополнитьПрофильПравамиПросмотраОтчетовГИСМ(ОписаниеПрофиля)Экспорт
	Возврат;
КонецПроцедуры
...
Процедура ПриЗаполненииВидовОграниченийПравОбъектовМетаданных(Описание) Экспорт
	...
	Описание = Описание + 
	"
	|Документ.ЗаявкаНаВыпускКиЗГИСМ.Чтение.Магазины
	|Документ.ЗаявкаНаВыпускКиЗГИСМ.Изменение.Магазины
	|Документ.МаркировкаТоваровГИСМ.Чтение.Магазины
	|Документ.МаркировкаТоваровГИСМ.Изменение.Магазины
	|Документ.ПеремаркировкаТоваровГИСМ.Чтение.Магазины
	|Документ.ПеремаркировкаТоваровГИСМ.Изменение.Магазины
	|Документ.УведомлениеОбИмпортеМаркированныхТоваровГИСМ.Чтение.Магазины
	|Документ.УведомлениеОбИмпортеМаркированныхТоваровГИСМ.Изменение.Магазины
	|Документ.УведомлениеОбОтгрузкеМаркированныхТоваровГИСМ.Чтение.Магазины
	|Документ.УведомлениеОбОтгрузкеМаркированныхТоваровГИСМ.Изменение.Магазины
	|Документ.УведомлениеОВвозеМаркированныхТоваровИзЕАЭСГИСМ.Чтение.Магазины
	|Документ.УведомлениеОВвозеМаркированныхТоваровИзЕАЭСГИСМ.Изменение.Магазины
	|Документ.УведомлениеОПоступленииМаркированныхТоваровГИСМ.Чтение.Магазины
	|Документ.УведомлениеОПоступленииМаркированныхТоваровГИСМ.Изменение.Магазины
	|Документ.УведомлениеОСписанииКиЗГИСМ.Чтение.Магазины
	|Документ.УведомлениеОСписанииКиЗГИСМ.Изменение.Магазины
	|";
...
// См. процедуру ИнтеграцияГИСМПереопределяемый.ОбработкаЗаполненияЗаявкиНаВыпускКиЗ
//
Процедура ОбработкаЗаполненияЗаявкиНаВыпускКиЗ(ЗаявкаОбъект, ДанныеЗаполнения, ТекстЗаполнения, СтандартнаяОбработка) Экспорт
	...
	ЗаявкаОбъект.Организация   = ЗначениеНастроекПовтИсп.ОрганизацияПоУмолчанию(ЗаявкаОбъект.Организация);
	ЗаявкаОбъект.Подразделение = ЗначениеНастроекПовтИсп.МагазинПоУмолчанию(ЗаявкаОбъект.Подразделение);
	
КонецПроцедуры

// См. процедуру ИнтеграцияГИСМПереопределяемый.ОбработкаЗаполненияУведомленияОбОтгрузкеГИСМ
//
Процедура ОбработкаЗаполненияУведомленияОбОтгрузкеГИСМ(УведомлениеОбъект, ДанныеЗаполнения, ТекстЗаполнения, СтандартнаяОбработка) Экспорт
	...
	ИначеЕсли ТипЗнч(ДанныеЗаполнения) = Тип("ДокументСсылка.ВозвратТоваровПоставщику") Тогда
		...
		ЗаполнитьУведомлениеОбОтгрузкеГИСМНаОснованииВозвратаТоваровПоставщику(УведомлениеОбъект, ДанныеЗаполнения, ТекстЗаполнения, СтандартнаяОбработка);
		
	КонецЕсли;
	
	УведомлениеОбъект.Подразделение = ЗначениеНастроекПовтИсп.МагазинПоУмолчанию(УведомлениеОбъект.Подразделение);
	УведомлениеОбъект.Ответственный = Пользователи.ТекущийПользователь();
	
КонецПроцедуры

// См. процедуру ИнтеграцияГИСМПереопределяемый.ОбработкаЗаполненияУведомленияОВвозеИзЕАЭСГИСМ
//
Процедура ОбработкаЗаполненияУведомленияОВвозеИзЕАЭСГИСМ(УведомлениеОбъект, ДанныеЗаполнения, ТекстЗаполнения, СтандартнаяОбработка) Экспорт
	...
	ЗаполнитьУведомлениеОВвозеИзЕАЭСГИСМНаОснованииПоступления(УведомлениеОбъект, ДанныеЗаполнения, ТекстЗаполнения, СтандартнаяОбработка);
	УведомлениеОбъект.Подразделение = ЗначениеНастроекПовтИсп.МагазинПоУмолчанию(УведомлениеОбъект.Подразделение);
	УведомлениеОбъект.Ответственный = Пользователи.ТекущийПользователь();
	
КонецПроцедуры

// См. процедуру ИнтеграцияГИСМПереопределяемый.ОбработкаЗаполненияУведомленияОбИмпортеГИСМ
//
Процедура ОбработкаЗаполненияУведомленияОбИмпортеГИСМ(УведомлениеОбъект, ДанныеЗаполнения, ТекстЗаполнения, СтандартнаяОбработка) Экспорт
	...
	ЗаполнитьУведомлениеОбИмпортеГИСМНаОснованииПоступления(УведомлениеОбъект, ДанныеЗаполнения, ТекстЗаполнения, СтандартнаяОбработка);
	УведомлениеОбъект.Подразделение = ЗначениеНастроекПовтИсп.МагазинПоУмолчанию(УведомлениеОбъект.Подразделение);
	УведомлениеОбъект.Ответственный = Пользователи.ТекущийПользователь();
	
КонецПроцедуры

// См. процедуру ИнтеграцияГИСМПереопределяемый.ОбработкаЗаполненияУведомленияОСписанииКиЗ
//
...
// См. процедуру ИнтеграцияГИСМПереопределяемый.ИспользоватьЗаявкиНаВыпускКиЗ
//
...
// См. процедуру ИнтеграцияГИСМПереопределяемый.ОрганизацияПодразделениеДокумента
//
...
// См. процедуру ИнтеграцияГИСМПереопределяемый.ВалютаРегламентированногоУчета
//
...
// См. процедуру ИнтеграцияГИСМПереопределяемый.ПредставлениеНоменклатуры
//
Функция ПредставлениеНоменклатуры(НоменклатураПредставление, ХарактеристикаПредставление) Экспорт
	
	Возврат ОбщегоНазначенияРТ.ПредставлениеНоменклатуры(НоменклатураПредставление, ХарактеристикаПредставление);
...
Процедура ЗаполнитьЗаявкуНаВыпускКиЗНаОснованииЗаказаПоставщику(ЗаявкаОбъект, ДанныеЗаполнения, ТекстЗаполнения, СтандартнаяОбработка) Экспорт
	...
	|	ДокументЗаказПоставщику.Магазин КАК Подразделение,
...
Процедура ЗаполнитьУведомлениеОбОтгрузкеГИСМНаОснованииРеализации(УведомлениеОбъект, ДанныеЗаполнения, ТекстЗаполнения, СтандартнаяОбработка) Экспорт
	...
	|	РеализацияТоваров.Магазин КАК Подразделение,
...
Процедура ЗаполнитьУведомлениеОбОтгрузкеГИСМНаОснованииВозвратаТоваровПоставщику(УведомлениеОбъект, ДанныеЗаполнения, ТекстЗаполнения, СтандартнаяОбработка) Экспорт
	...
	|	ВозвратТоваровПоставщику.Магазин КАК Подразделение,
...
Процедура ЗаполнитьУведомлениеОВвозеИзЕАЭСГИСМНаОснованииПоступления(УведомлениеОбъект, ДанныеЗаполнения, ТекстЗаполнения, СтандартнаяОбработка) Экспорт
	...
	|	ПоступлениеТоваров.Магазин КАК Подразделение,
...
Процедура ЗаполнитьУведомлениеОСписанииКиЗНаОснованииВнутреннегоПотребления(УведомлениеОбъект, ДанныеЗаполнения, ТекстЗаполнения, СтандартнаяОбработка) Экспорт
	...
	|	СписаниеТоваров.Магазин КАК Подразделение,
	...
	|	ВЫБОР
	|		КОГДА СписаниеТоваровСерии.Номенклатура.КиЗГИСМ
	|			ТОГДА ЛОЖЬ
	|		КОГДА СписаниеТоваровСерии.Номенклатура.ПродукцияМаркируемаяДляГИСМ
	|			ТОГДА ИСТИНА
...
// См. процедуру ИнтеграцияГИСМПереопределяемый.ЗапросПоПоступившимКиЗ
//
...
// См. процедуру ИнтеграцияГИСМПереопределяемый.ДанныеПоЗаявкамНаВыпускКиЗ
//
Процедура ДанныеПоЗаявкамНаВыпускКиЗ(ДокументыКПодтверждению, ДанныеПоЗаявкам) Экспорт
	...
	ДанныеПоЗаявкам = Новый Структура;
	ДанныеПоЗаявкам.Вставить("НомераКиЗКПодтверждению", РезультатЗапроса[8]);
	ДанныеПоЗаявкам.Вставить("ПроблемыДублиКиЗ",        РезультатЗапроса[9]);
	ДанныеПоЗаявкам.Вставить("ПроблемыСопоставления",   РезультатЗапроса[10]);
	
КонецПроцедуры

// См. процедуру ИнтеграцияГИСМПереопределяемый.ДанныеПоУведомлениямОПоступлении
//
Процедура ДанныеПоУведомлениямОПоступлении(ДокументыКПодтверждению, ДанныеПоЗаявкамКиЗ) Экспорт
	...
	ДанныеПоЗаявкамКиЗ = Новый Структура;
	ДанныеПоЗаявкамКиЗ.Вставить("НомераКиЗКПодтверждению", РезультатЗапроса[4]);
	ДанныеПоЗаявкамКиЗ.Вставить("ПроблемыДублиКиЗ",        РезультатЗапроса[5]);
	ДанныеПоЗаявкамКиЗ.Вставить("ПроблемыСопоставления",   Неопределено);
	
КонецПроцедуры

// См. процедуру ИнтеграцияГИСМПереопределяемый.ДокументОснованиеВозвратПоставщику
//
...
// См. процедуру ИнтеграцияГИСМПереопределяемый.РеквизитыКонтрагента
//
Процедура РеквизитыКонтрагента(Контрагент, Реквизиты) Экспорт
	...
	ЭтоРозничныйПокупатель = Контрагент = ОбщегоНазначенияРТПовтИсп.РозничныйПокупатель();
	
	Реквизиты.Вставить("ЮридическийАдрес", ЮридическийАдрес);
	Реквизиты.Вставить("ЭтоРозничныйПокупатель", ЭтоРозничныйПокупатель);
...
Процедура ЗаполнитьПредставлениеТоваровУведомленияОПоступлении(НомераКиЗ) Экспорт
	...
	Для Каждого ТекСтрока Из НомераКиЗ Цикл
		...
		Если Выборка.НайтиСледующий(ТекСтрока.НомерСтроки, "НомерСтроки") Тогда
			...
			ТекСтрока.НоменклатураПредставление = ОбщегоНазначенияРТ.ПредставлениеНоменклатуры(
...
// См. процедуру ИнтеграцияГИСМПереопределяемый.ДоступенОтчетОРозничныхПродажах
//
Процедура ДоступенОтчетОРозничныхПродажах(Доступен) Экспорт
	
	Доступен = ПравоДоступа("Чтение", Метаданные.Документы.ОтчетОРозничныхПродажах);
	
КонецПроцедуры

// См. процедуру ИнтеграцияГИСМПереопределяемый.ДоступенВозвратТоваровОтРозничногоКлиента
//
Процедура ДоступенВозвратТоваровОтРозничногоКлиента(Доступен) Экспорт
	
	Доступен = ПравоДоступа("Чтение", Метаданные.Документы.ВозвратТоваровОтПокупателя);
	
КонецПроцедуры

// См. процедура ИнтеграцияГИСМПереопределяемый.ТекстЗапросаОтчетыОРозничныхПродажах
//
...
// См. процедуру ИнтеграцияГИСМПереопределяемый.ТекстЗапросаОтчетыОРозничныхПродажахОжидайте
//
...
// См. процедуру ИнтеграцияГИСМПереопределяемый.ТекстЗапросаОтчетыОРозничныхПродажахОтработайте
//
...
// См. процедуру ИнтеграцияГИСМПереопределяемый.ТекстЗапросаУведомленияОСписанииКиЗГИСМ
//
...
// См. процедуру ИнтеграцияГИСМПереопределяемый.ТекстЗапросаУведомленияОСписанииКиЗГИСМОформите
//
...
// См. процедуру ИнтеграцияГИСМПереопределяемый.ТекстЗапросаУведомленияОбОтгрузке
//
...
// См. процедуру ИнтеграцияГИСМПереопределяемый.ТекстЗапросаУведомленияОбОтгрузкеОформите
//
...
// См. процедуру ИнтеграцияГИСМПереопределяемый.ТекстЗапросаЗаявкиНаВыпускКиЗГИСМ
//
...
// См. процедуру ИнтеграцияГИСМПереопределяемый.ТекстЗапросаЗаявкиНаВыпускКиЗГИСМОформите
//
...
// См. процедуру ИнтеграцияГИСМПереопределяемый.ТекстЗапросаУведомленияОВвозеИзЕАЭС
//
...
// См. процедуру ИнтеграцияГИСМПереопределяемый.ТекстЗапросаУведомленияОВвозеИзЕАЭСОформите
//
...
// См. процедуру ИнтеграцияГИСМПереопределяемый.ТекстЗапросаУведомленияОбИмпорте
//
...
// См. процедуру ИнтеграцияГИСМПереопределяемый.ТекстЗапросаУведомленияОбИмпортеОформите
//
...
// См. процедуру ИнтеграцияГИСМПереопределяемый.ТекстЗапросаКоличествоВозвратовОтРозничныхКлиентов
//
...
// См. процедуру ИнтеграцияГИСМПереопределяемый.ТекстЗапросаКоличествоОтчетовОРозничныхПродажах
//
...
// См. процедуру ИнтеграцияГИСМПереопределяемый.ТекстЗапросаВозвратыТоваровОтРозничныхКлиентовОжидайте
//
...
// См. процедцру ИнтеграцияГИСМПереопределяемый.ТекстЗапросаДинамическогоСпискаРаспоряженийУведомлениеОбИмпорте
//
...
// См. процедуру ИнтеграцияГИСМПереопределяемый.ТекстЗапросаДинамическогоСпискаРаспоряженийУведомлениеОВвозеИзЕАЭС
//
...
// См. процедуру ИнтеграцияГИСМПереопределяемый.ТекстЗапросаДинамическогоСпискаРаспоряженийУведомлениеОСписании
//
...
// См. процедуру ИнтеграцияГИСМПереопределяемый.ТекстЗапросаДинамическогоСпискаРаспоряженийУведомлениеОбОтгрузке
//
...
// См. процедуру ИнтеграцияГИСМПереопределяемый.ТекстЗапросаДинамическогоСпискаРаспоряженийЗаявкаНаВыпускКиЗ
//
...
// См. процедуру ИнтеграцияГИСМПереопределяемый.ИспользоватьНесколькоОрганизаций
//
Процедура ИспользоватьНесколькоОрганизаций(Использовать) Экспорт
	
	Использовать = ПолучитьФункциональнуюОпцию("ИспользоватьНесколькоОрганизаций");

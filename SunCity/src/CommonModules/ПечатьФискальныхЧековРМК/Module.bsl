...
Процедура ДополнитьПараметрыЧека(ПараметрыЧека, ДанныеДляДополнения) Экспорт
	...
	СтрокаПозицииЧека = МенеджерОборудованияКлиентСервер.ПараметрыТекстовойСтрокиЧека(ДанныеДляДополнения);
	ПараметрыЧека.ПозицииЧека.Добавить(СтрокаПозицииЧека);
...
Функция УсловияВыполнены(ШаблонЧека, Идентификатор, ИмяРаздела, СтрокаШапкиЧека, СтрокаДанных = Неопределено) Экспорт
	...
	Если ТипЗнч(ШаблонЧека) = Тип("СправочникСсылка.ХранилищеШаблоновРМК") 
	...
	Если ТаблицаУсловий = Неопределено Тогда 
		...
		Возврат Истина;
	КонецЕсли;
	УсловияВыводаСоставнойСтроки = ТаблицаУсловий.НайтиСтроки(
		Новый Структура("Идентификатор", Число(Идентификатор)));
	
	Равно = Перечисления.ВидСравненияЗначенийРМК.Равно;
	НеРавно = Перечисления.ВидСравненияЗначенийРМК.НеРавно;
	Больше = Перечисления.ВидСравненияЗначенийРМК.Больше;
	БольшеИлиРавно = Перечисления.ВидСравненияЗначенийРМК.БольшеИлиРавно;
	Меньше = Перечисления.ВидСравненияЗначенийРМК.Меньше;
	МеньшеИлиРавно = Перечисления.ВидСравненияЗначенийРМК.МеньшеИлиРавно;
	Для Каждого Условие Из УсловияВыводаСоставнойСтроки Цикл
		...
		ОбщегоНазначенияРМКПереопределяемый.ВычислитьЛевоеЗначениеУсловия(Условие.ТипУсловия,
			СтруктураДанныРасчета, ЛевоеЗначение);

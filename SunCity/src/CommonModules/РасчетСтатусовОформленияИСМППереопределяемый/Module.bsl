...
Процедура ПриОпределенииИменРеквизитовДляРасчетаСтатусаОформления(
		...
		РасчетСтатусовОформленияИСРТ.ПриОпределенииИменРеквизитовДокументаДляРасчетаСтатусаОформленияДокументаИСМП(
...
Процедура ПриОпределенииТекстаЗапросаДляРасчетаСтатусаОформления(
	...
	РасчетСтатусовОформленияИСРТ.ПриОпределенииТекстаЗапросаРасчетаСтатусаОформленияДокументаИСМП(
		МетаданныеДокументаОснования,
		МетаданныеДокументаИСМП,
		ТекстЗапроса,

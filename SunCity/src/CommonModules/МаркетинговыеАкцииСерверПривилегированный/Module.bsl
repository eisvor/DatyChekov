////////////////////////////////////////////////////////////////////////////////
// МаркетинговыеАкцииСерверПривилегированный содержит процедуры и функции 
...
// Проверяет реализацию и погашения серийных номеров.
//
// Параметры:
//  СтруктураДокумента - Структура - структура документа для проверки.
...
// Проверяет остатки серийных номеров по товарам.
//
// Параметры:
//  ТаблицаЗначений_Товары - ТаблицаЗначений - таблица значений товаров.
//  ТаблицаЗначений_СерийныеНомера - таблица значений серийных номеров.
//  Отказ - Булево - признак отказа от выполнения операции.
//  ТекстОшибки - Строка - описание ошибки.
//
...
// Подбирает таблицу серийных номеров.
//
// Параметры:
//  СтруктураПараметров - Структура - структура параметров подбора серийных номеров.
//  Текст - Строка - текст для поиска и подбора серийных номеров.
//
// Возвращаемое значение:
//  Массив - массмв серийных номеров.
//
Функция МассивСерийныхНомеров(СтруктураПараметров, Текст) Экспорт
	...
	МассивСерийныхНомеров = МаркетинговыеАкцииСервер.СерийныеНомераПоТексту(Текст, МассивИспользуемыхСерийныхНомеров, Номенклатура, ТипСерийногоНомера);

...
#Область ПроцедурыОбработчикиРегламентныхЗаданий
...
//
// Параметры: 
//  СегментСсылка - СправочникСсылка.СегментыНоменклатуры - сегмент по которому ведется отбор.
//  
...
//
// Параметры:
//  ГруппаСсылка - СправочникСсылка.ГруппыПолучателейСкидки - группа получателей скидки.
//
...
#Область ПроцедурыОбработчикиСхемыКомпоновки
...
// 
// Возвращаемое значение:
//  СхемаКомпоновкиДанных - СКД для сегмента номенклатуры.
//
Функция ПолучитьСКД(СегментСсылка) Экспорт
	...
	Если СегментСсылка.СпособФормирования <>
		...
		Если СКД.НаборыДанных.Найти("СписокСегмента") <> Неопределено Тогда
			...
			ОбщегоНазначенияРТКлиентСервер.НовыйОтбор(
...
//
// Параметры: 
//  ГруппаСсылка - СправочникСсылка.ГруппыПолучателейСкидки - группа получателей для отбора.
// 
// Возвращаемое значение:
//  СхемаКомпоновкиДанных - СКД для группы получателей.
//
Функция ПолучитьСКДГруппыПолучателейСкидки(ГруппаСсылка) Экспорт
	...
	Если ГруппаСсылка.СпособФормирования <> Перечисления.СпособыФормированияСегментов.ФормироватьДинамически Тогда
		...
		// добавить отбор по сегменту
		ОбщегоНазначенияРТКлиентСервер.НовыйОтбор(СКД.НастройкиПоУмолчанию, Новый ПолеКомпоновкиДанных("ГруппаПолучателейСкидки"), ГруппаСсылка);
...
//
// Параметры:
//  ДанныеФормыОбъект - ДанныеФормыОбъект - объект в котором необходимо сохранить СКД.
//  СхемаКомпоновки - СхемаКомпоновкиДанных - СКД для сохранения.
//
...
// 
// Возвращаемое значение:
//  СписокЗначений - элементы входящие в сегмент.
//
...
// 
// Возвращаемое значение:
//  ТаблицаЗначений - элементы входящие в сегмент.
//
...
// 
// Возвращаемое значение:
//  Массив - элементы входящие в сегмент.
//
...
// 
// Возвращаемое значение:
//  Число - количество элементов в сегменте.
//
...
//
// Параметры:
//  ОбъектСсылка - СправочникСсылка.Номенклатура - ссылка на анализируемый объект - номенклатуру.
//  СегментСсылка - СправочникСсылка.СегментыНоменклатуры - ссылка на сегмент номенклатуры.
//  ХарактеристикаОбъекта - СправочникСсылка.ХарактеристикиНоменклатуры - характеристика номенклатуры.
//  Динамический - Булево - способ формирования сегмента.
//  
// Возвращаемое значение:
//  ТаблицаЗначений - элементы входяшие в сегмент.
//
...
//
// Параметры:
//  ОбъектСсылка - СправочникСсылка.Номенклатура - ссылка на номенклатуру.
//  ВключатьДинамические - Булево - если истина, то с учетом динамических сегментов.
//
// Возвращаемое значение:
//  ТаблицаЗначений - сегменты, в которые входит объект..
//
...
Функция ПолучитьНастройкиСписка(СегментСсылка)
	...
	СКД = СегментСсылка.СхемаКомпоновкиДанных.Получить();
	НастройкиСегмента = Неопределено;

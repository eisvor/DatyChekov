...
Процедура ФункциональнаяОпцияИспользуется(Знач ИмяФормы, Результат) Экспорт
	...
	ТорговыеПредложенияРТ.ФункциональнаяОпцияИспользуется(ИмяФормы, Результат);
...
Процедура ПолучитьСпособыДоставки(СпособыДоставки, ВидДоставки = Неопределено) Экспорт
	...
	ТорговыеПредложенияРТ.ПолучитьСпособыДоставки(СпособыДоставки, ВидДоставки);
...
Процедура ПолучитьИмяСтавкиНДС(Знач Ссылка, ИмяСтавкиНДС) Экспорт
	...
	ТорговыеПредложенияРТ.ПолучитьИмяСтавкиНДС(Ссылка, ИмяСтавкиНДС);
...
Процедура СвойстваКонтекстаДокументовДляПоискаПредложений(Знач ПараметрКоманды, КонтекстИсточника, ТаблицаТовары) Экспорт
	...
	ТорговыеПредложенияРТ.СвойстваКонтекстаДокументовДляПоискаПредложений(ПараметрКоманды, КонтекстИсточника, ТаблицаТовары);
...
Процедура ПриСозданииНаСервере(Форма) Экспорт
	...
	ТорговыеПредложенияРТ.ПриСозданииНаСервере(Форма);
...
Процедура СоздатьДокументЗаказПоставщикуНаОснованииТорговогоПредложения(Знач ДанныеЗаполнения, ДокументОбъект, Отказ) Экспорт
	...
	ТорговыеПредложенияРТ.СоздатьДокументЗаказПоставщикуНаОснованииТорговогоПредложения(
		ДанныеЗаполнения, ДокументОбъект, Отказ);
...
Процедура ПересчитатьСуммуПоСтроке(СтрокаТоваров) Экспорт
	...
	ТорговыеПредложенияРТ.ПересчитатьСуммуПоСтроке(СтрокаТоваров);
...
Процедура ЗаполнитьРеквизитыЗаказов(ТаблицаЗаказов) Экспорт
	...
	ТорговыеПредложенияРТ.ЗаполнитьРеквизитыЗаказов(ТаблицаЗаказов);
...
Процедура ИнициализацияСпискаСопоставленияНоменклатуры(Список) Экспорт
	...
	//ТорговыеПредложенияРТ.ИнициализацияСпискаСопоставленияНоменклатуры(Список);
...
Процедура ЗаполнитьРеквизитыНоменклатурыДляФормированияЗаказа(Знач Номенклатура, Результат) Экспорт
	...
	ТорговыеПредложенияРТ.ЗаполнитьРеквизитыНоменклатурыДляФормированияЗаказа(Номенклатура, Результат);
...
Процедура ПолучитьВалютуРегламентированногоУчета(Валюта) Экспорт
	...
	ТорговыеПредложенияРТ.ПолучитьВалютуРегламентированногоУчета(Валюта);
...
Процедура УдалитьДокументыЗаказПоставщику(ТаблицаДокументы, Отказ) Экспорт
	...
	ТорговыеПредложенияРТ.УдалитьДокументыЗаказПоставщику(ТаблицаДокументы, Отказ);
...
Процедура УстановитьУсловноеОформлениеЕдиницИзмерения(Форма, Знач ИмяПоляВводаЕдиницИзмерения, Знач ПутьКПолюОтбора) Экспорт
	...
	ТорговыеПредложенияРТ.УстановитьУсловноеОформлениеЕдиницИзмерения(Форма, ИмяПоляВводаЕдиницИзмерения, ПутьКПолюОтбора);
...
Процедура ЗаполнитьАдресаАбонента(АдресаАбонента) Экспорт
	...
	ТорговыеПредложенияРТ.ЗаполнитьАдресаАбонента(АдресаАбонента);
...
Процедура ПолучитьЗначениеСтавкиНДС(Знач ИмяСтавкиНДС, Ссылка) Экспорт
	...
	ТорговыеПредложенияРТ.ПолучитьЗначениеСтавкиНДС(ИмяСтавкиНДС, Ссылка);

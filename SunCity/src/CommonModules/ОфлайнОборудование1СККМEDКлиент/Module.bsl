...
Процедура НачатьВыгрузкуДанныхЗавершение(Результат, ДополнительныеПараметры) Экспорт
	...
	Иначе
		...
		ВыходныеПараметры.Добавить("999");
		ВыходныеПараметры.Добавить(НСтр("ru='Операция невозможна, отсутствует подсистема Обмен данными.'"));
...
// Записать результат выгрузки в файл.
// 
// Параметры:
//  АдресХраненияРезультата - Строка - Адрес хранения результата

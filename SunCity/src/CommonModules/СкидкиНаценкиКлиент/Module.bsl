////////////////////////////////////////////////////////////////////////////////
// СкидкиНаценкиКлиент содержит процедуры и функции для работы 
...
// Сбрасывает флаг СкидкиРассчитаны и делает недоступными колонки табличной части.
//
// Параметры:
//  Форма - УправляемаяФорма - форма в которой сбрасывается флаг рассчета скидок.
//
...
//
// Параметры:
//  СуммаСкидкиНаценки - Число - сумма скидок.
//  Валюта - Строка - наименование валюты строкой.
//
...
//  АдресПримененныхСкидокВоВременномХранилище - Строка - адрес во временном хранилище.
//

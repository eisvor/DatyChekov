...
Процедура ОпределитьРазделыСВариантамиОтчетов(Разделы) Экспорт
	...
	Разделы.Добавить(Метаданные.Подсистемы.Маркетинг, НСтр("ru = 'Маркетинг'"));
	...
	Разделы.Добавить(Метаданные.Подсистемы.Финансы, НСтр("ru = 'Финансы'"));
	Разделы.Добавить(Метаданные.Подсистемы.Персонал, НСтр("ru = 'Персонал'"));
	Разделы.Добавить(Метаданные.Подсистемы.Органайзер, НСтр("ru = 'Органайзер'"));
	Разделы.Добавить(Метаданные.Подсистемы.НормативноСправочнаяИнформация, НСтр("ru = 'Нормативно-справочная информация'"));
...
Процедура НастроитьВариантыОтчетов(Настройки) Экспорт
	...
	ВариантыОтчетов.НастроитьОтчетВМодулеМенеджера(Настройки, Метаданные.Отчеты.АнализДвиженийНоменклатуры);
	Вариант = ВариантыОтчетов.ОписаниеВарианта(Настройки, Метаданные.Отчеты.АнализДвиженийНоменклатуры, "ПоМагазинам");
	Вариант.Включен = Ложь;
	
	ВариантыОтчетов.НастроитьОтчетВМодулеМенеджера(Настройки, Метаданные.Отчеты.ВедомостьДвиженияСерий);
	Вариант = ВариантыОтчетов.ОписаниеВарианта(Настройки, Метаданные.Отчеты.ВедомостьДвиженияСерий, "ВедомостьДвиженияСерий");
	Вариант.Включен = Истина;
	
	ВариантыОтчетов.НастроитьОтчетВМодулеМенеджера(Настройки, Метаданные.Отчеты.ВедомостьПоТоварамНаСкладахСвободныеОстатки);
	Вариант = ВариантыОтчетов.ОписаниеВарианта(Настройки, Метаданные.Отчеты.ВедомостьПоТоварамНаСкладахСвободныеОстатки, "ОстаткиНаСкладах");
	Вариант.Включен = Ложь;
	
	ВариантыОтчетов.НастроитьОтчетВМодулеМенеджера(Настройки, Метаданные.Отчеты.ДанныеАссортиментаНоменклатуры);
	Вариант = ВариантыОтчетов.ОписаниеВарианта(Настройки, Метаданные.Отчеты.ДанныеАссортиментаНоменклатуры, "Основной");
	Вариант.Включен = Ложь;
	
	ВариантыОтчетов.НастроитьОтчетВМодулеМенеджера(Настройки, Метаданные.Отчеты.ПрайсЛист);
	Вариант = ВариантыОтчетов.ОписаниеВарианта(Настройки, Метаданные.Отчеты.ПрайсЛист, "ПрайсЛист");
	Вариант.Включен = Истина;
	
	////////////////////////////////////////////////////////////////////////////////
	//Запасы и закупки
	
	ВариантыОтчетов.НастроитьОтчетВМодулеМенеджера(Настройки, Метаданные.Отчеты.АнализРасхожденийПриПоступленииТоваров);
	Вариант = ВариантыОтчетов.ОписаниеВарианта(Настройки, Метаданные.Отчеты.АнализРасхожденийПриПоступленииТоваров, "АнализРасхождений");
	Вариант.Включен = Ложь;
	
	ВариантыОтчетов.НастроитьОтчетВМодулеМенеджера(Настройки, Метаданные.Отчеты.СостояниеРасчетовСПоставщиками);
	Вариант = ВариантыОтчетов.ОписаниеВарианта(Настройки, Метаданные.Отчеты.СостояниеРасчетовСПоставщиками, "СостояниеРасчетовСПоставщикамиИзДокумента");
	Вариант.Включен = Ложь;
	
	////////////////////////////////////////////////////////////////////////////////
	//Склад
	ВариантыОтчетов.НастроитьОтчетВМодулеМенеджера(Настройки, Метаданные.Отчеты.ОформлениеИзлишковНедостачТоваров);
	Вариант = ВариантыОтчетов.ОписаниеВарианта(Настройки, Метаданные.Отчеты.ОформлениеИзлишковНедостачТоваров, "ОформлениеИзлишковНедостачКонтекст");
	Вариант.Включен = Ложь;
	
	ВариантыОтчетов.НастроитьОтчетВМодулеМенеджера(Настройки, Метаданные.Отчеты.ОтклоненияПриПеремещенииТоваров);
	Вариант = ВариантыОтчетов.ОписаниеВарианта(Настройки, Метаданные.Отчеты.ОтклоненияПриПеремещенииТоваров, "ОтклоненияПеремещения");
	Вариант.Включен = Ложь;
	
	Вариант = ВариантыОтчетов.ОписаниеВарианта(Настройки, Метаданные.Отчеты.АнализДвиженийНоменклатуры, "ПоМагазинам");
	Вариант.Включен = Ложь;
	
	Вариант = ВариантыОтчетов.ОписаниеВарианта(Настройки, Метаданные.Отчеты.АнализДвиженийНоменклатуры, "ПоСкладам");
	Вариант.Включен = Ложь;
	
	ВариантыОтчетов.НастроитьОтчетВМодулеМенеджера(Настройки, Метаданные.Отчеты.ВедомостьПоОстаткамТоваровЗапрещенныхКПродаже);
	
	////////////////////////////////////////////////////////////////////////////////
	// Маркетинг
	Отчет = ВариантыОтчетов.ОписаниеОтчета(Настройки, Метаданные.Отчеты.ДанныеАссортиментаНоменклатуры);
	Отчет.Размещение.Удалить(Метаданные.Подсистемы.Маркетинг.Подсистемы.Ассортимент);
	
	ВариантыОтчетов.НастроитьОтчетВМодулеМенеджера(Настройки, Метаданные.Отчеты.ПересеченияСегментаНоменклатуры);
	Отчет = ВариантыОтчетов.ОписаниеОтчета(Настройки, Метаданные.Отчеты.ПересеченияСегментаНоменклатуры);
	Отчет.Размещение.Удалить(Метаданные.Подсистемы.Маркетинг.Подсистемы.Сегментация);
	
	Отчет = ВариантыОтчетов.ОписаниеОтчета(Настройки, Метаданные.Отчеты.СоставСегмента);
	Отчет.Размещение.Удалить(Метаданные.Подсистемы.Маркетинг.Подсистемы.Сегментация);
	
	Отчет = ВариантыОтчетов.ОписаниеОтчета(Настройки, Метаданные.Отчеты.ПересеченияСегментаНоменклатуры);
	Отчет.Размещение.Удалить(Метаданные.Подсистемы.Маркетинг.Подсистемы.Ценообразование);
	
	ВариантыОтчетов.НастроитьОтчетВМодулеМенеджера(Настройки, Метаданные.Отчеты.ПересеченияГруппыПолучателейСкидки);
	Отчет = ВариантыОтчетов.ОписаниеОтчета(Настройки, Метаданные.Отчеты.ПересеченияГруппыПолучателейСкидки);
	Отчет.Размещение.Удалить(Метаданные.Подсистемы.Маркетинг.Подсистемы.МаркетинговыеАкции);
	
	ВариантыОтчетов.НастроитьОтчетВМодулеМенеджера(Настройки, Метаданные.Отчеты.ABCXYZАнализПродаж);
	ВариантыОтчетов.НастроитьОтчетВМодулеМенеджера(Настройки, Метаданные.Отчеты.АнализИсполненияАссортимента);
	ВариантыОтчетов.НастроитьОтчетВМодулеМенеджера(Настройки, Метаданные.Отчеты.АнализПогашенияСертификатов);
	ВариантыОтчетов.НастроитьОтчетВМодулеМенеджера(Настройки, Метаданные.Отчеты.БонусныеБаллы);
	ВариантыОтчетов.НастроитьОтчетВМодулеМенеджера(Настройки, Метаданные.Отчеты.ВедомостьДвиженияПодарочныхСертификатов);
	ВариантыОтчетов.НастроитьОтчетВМодулеМенеджера(Настройки, Метаданные.Отчеты.ДействующиеМаркетинговыеАкции);
	ВариантыОтчетов.НастроитьОтчетВМодулеМенеджера(Настройки, Метаданные.Отчеты.КвотыАссортимента);
	ВариантыОтчетов.НастроитьОтчетВМодулеМенеджера(Настройки, Метаданные.Отчеты.КонвертацияПосетителей);
	ВариантыОтчетов.НастроитьОтчетВМодулеМенеджера(Настройки, Метаданные.Отчеты.НаполненностьАссортимента);
	ВариантыОтчетов.НастроитьОтчетВМодулеМенеджера(Настройки, Метаданные.Отчеты.ОтчетОДвиженияхСертификатов);
	ВариантыОтчетов.НастроитьОтчетВМодулеМенеджера(Настройки, Метаданные.Отчеты.ОтчетПоДаннымОпроса);
	ВариантыОтчетов.НастроитьОтчетВМодулеМенеджера(Настройки, Метаданные.Отчеты.ОтчетЭмитентуПоПодарочнымСертификатам);
	ВариантыОтчетов.НастроитьОтчетВМодулеМенеджера(Настройки, Метаданные.Отчеты.ОценкаПримененияСкидок);
	ВариантыОтчетов.НастроитьОтчетВМодулеМенеджера(Настройки, Метаданные.Отчеты.ОценкаПродаж);
	ВариантыОтчетов.НастроитьОтчетВМодулеМенеджера(Настройки, Метаданные.Отчеты.ОценкаПродвиженияТовара);
	ВариантыОтчетов.НастроитьОтчетВМодулеМенеджера(Настройки, Метаданные.Отчеты.ОценкаРаспродажи);
	ВариантыОтчетов.НастроитьОтчетВМодулеМенеджера(Настройки, Метаданные.Отчеты.ОценкаЭффективностиМаркетинговыхМероприятий);
	ВариантыОтчетов.НастроитьОтчетВМодулеМенеджера(Настройки, Метаданные.Отчеты.ПрайсЛист);
	ВариантыОтчетов.НастроитьОтчетВМодулеМенеджера(Настройки, Метаданные.Отчеты.ПричиныВозвратовОтПокупателя);
	ВариантыОтчетов.НастроитьОтчетВМодулеМенеджера(Настройки, Метаданные.Отчеты.ПричиныВозвратовПоставщикам);
	ВариантыОтчетов.НастроитьОтчетВМодулеМенеджера(Настройки, Метаданные.Отчеты.ПричиныСписания);
	...
	ВариантыОтчетов.НастроитьОтчетВМодулеМенеджера(Настройки, Метаданные.Отчеты.ПродажиПоДисконтнымКартамЧека);
	ВариантыОтчетов.НастроитьОтчетВМодулеМенеджера(Настройки, Метаданные.Отчеты.РезультатыПримененияЦен);
	ВариантыОтчетов.НастроитьОтчетВМодулеМенеджера(Настройки, Метаданные.Отчеты.СтоимостнаяОценкаСклада);
	ВариантыОтчетов.НастроитьОтчетВМодулеМенеджера(Настройки, Метаданные.Отчеты.УсловияПравилЦенообразования);
	ВариантыОтчетов.НастроитьОтчетВМодулеМенеджера(Настройки, Метаданные.Отчеты.ЦеныКПрименению);
	ВариантыОтчетов.НастроитьОтчетВМодулеМенеджера(Настройки, Метаданные.Отчеты.ЦеныПоВидамЦен);
	
	//Продажи
	ВариантыОтчетов.НастроитьОтчетВМодулеМенеджера(Настройки, Метаданные.Отчеты.ОстаткиПоЗаказу);
	Вариант = ВариантыОтчетов.ОписаниеВарианта(Настройки, Метаданные.Отчеты.ОстаткиПоЗаказу, "СостояниеВыполненияЗаказа");
	Вариант.Включен = Ложь;
	
	ВариантыОтчетов.НастроитьОтчетВМодулеМенеджера(Настройки, Метаданные.Отчеты.ЖурналУчетаПродажиАлкогольнойПродукции);
	
	//Сотрудники
	Вариант = ВариантыОтчетов.ОписаниеВарианта(Настройки, Метаданные.Отчеты.ДействующиеПравилаРасчетаПремий, "Основной");
	ВариантыОтчетов.НастроитьОтчетВМодулеМенеджера(Настройки, Метаданные.Отчеты.АнализПравилРасчетаПремий);
	
	Вариант = ВариантыОтчетов.ОписаниеВарианта(Настройки, Метаданные.Отчеты.ПланФактПоРабочемуВремениСотрудников, "ПланФактДетальный");
	Вариант.Размещение.Удалить(Метаданные.Подсистемы.Персонал.Подсистемы.Сотрудники);

	//РасхожденияПриПриемкеТоваров
	Вариант = ВариантыОтчетов.ОписаниеВарианта(Настройки, Метаданные.Отчеты.РасхожденияПриПриемкеТоваров, "НеустановленныеРасхождения");
	Вариант.Размещение.Удалить(Метаданные.Подсистемы.Склад.Подсистемы.ПриемкаОтгрузка);
	
	//НСИ
	ВариантыОтчетов.НастроитьОтчетВМодулеМенеджера(Настройки, Метаданные.Отчеты.НезаполненныеРеквизитыЕГАИС);
	ВариантыОтчетов.НастроитьОтчетВМодулеМенеджера(Настройки, Метаданные.Отчеты.РасхожденияРеквизитовЕГАИС);
	
	// Финансы
	ВариантыОтчетов.НастроитьОтчетВМодулеМенеджера(Настройки, Метаданные.Отчеты.ОстаткиИДвиженияДенежныхСредствВКассахККМПоВидамВыручки);
	ВариантыОтчетов.НастроитьОтчетВМодулеМенеджера(Настройки, Метаданные.Отчеты.ОстаткиИДвиженияДенежныхСредствПоВидамВыручки);
	
	ВариантыОтчетов.НастроитьОтчетВМодулеМенеджера(Настройки, Метаданные.Отчеты.ДвиженияДенежныхСредствПоБанковскимКредитам);
	ВариантыОтчетов.НастроитьОтчетВМодулеМенеджера(Настройки, Метаданные.Отчеты.ДвиженияДенежныхСредствПоСтатьям);
	ВариантыОтчетов.НастроитьОтчетВМодулеМенеджера(Настройки, Метаданные.Отчеты.ДвиженияДенежныхСредствПоТипамОплаты);
	ВариантыОтчетов.НастроитьОтчетВМодулеМенеджера(Настройки, Метаданные.Отчеты.КонтрольКассовойКниги);
	ВариантыОтчетов.НастроитьОтчетВМодулеМенеджера(Настройки, Метаданные.Отчеты.ОстаткиИДвиженияДенежныхСредств);
	ВариантыОтчетов.НастроитьОтчетВМодулеМенеджера(Настройки, Метаданные.Отчеты.ОстаткиИДвиженияДенежныхСредствБезналичных);
	ВариантыОтчетов.НастроитьОтчетВМодулеМенеджера(Настройки, Метаданные.Отчеты.ПланОплатыПоставок);
	ВариантыОтчетов.НастроитьОтчетВМодулеМенеджера(Настройки, Метаданные.Отчеты.ПродажиПоПлатежнымКартам);
	ВариантыОтчетов.НастроитьОтчетВМодулеМенеджера(Настройки, Метаданные.Отчеты.СостояниеРасчетовСПоставщиками);
	
	// Администрирование
	ВариантыОтчетов.НастроитьОтчетВМодулеМенеджера(Настройки, Метаданные.Отчеты.СтатистикаКлючевыхОпераций);
	...
	ЗащитаПерсональныхДанных.ПриНастройкеВариантовОтчетов(Настройки);
	// Конец СтандартныеПодсистемы.ЗащитаПерсональныхДанных
	
	// БРМК
	Отчеты.НезавершенныеДействияСЧекомРМК.ПриНастройкеВариантовОтчетов(Настройки);
	
	Вариант = ВариантыОтчетов.ОписаниеВарианта(Настройки, Метаданные.Отчеты.ЖурналУчетаСчетовФактур, "");
	Вариант.Включен = Ложь;

	Вариант = ВариантыОтчетов.ОписаниеВарианта(Настройки, Метаданные.Отчеты.КонтрольКассовойКниги, "");
	Вариант.Включен = Ложь;

	Вариант = ВариантыОтчетов.ОписаниеВарианта(Настройки, Метаданные.Отчеты.МониторПоказателей, "");
	Вариант.Включен = Истина;
...
Процедура ОпределитьОбъектыСКомандамиОтчетов(Объекты) Экспорт
	...
	Объекты.Добавить(Метаданные.Справочники.ГруппыПолучателейСкидки);
	Объекты.Добавить(Метаданные.Справочники.СегментыНоменклатуры);
	Объекты.Добавить(Метаданные.Справочники.ПравилаЦенообразования);
	...
	Объекты.Добавить(Метаданные.Документы.ОрдерНаОтражениеРезультатовПересчетовТоваров);
	Объекты.Добавить(Метаданные.Документы.ПеремещениеТоваров);
	Объекты.Добавить(Метаданные.Документы.ПоступлениеТоваров);
	Объекты.Добавить(Метаданные.Документы.ПриказНаПроведениеИнвентаризацииТоваров);

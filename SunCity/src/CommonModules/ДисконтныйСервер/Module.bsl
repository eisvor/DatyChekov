...
// Формирует запрос дисконтному серверу
// о получении сведений о накоплениях по карте,
// используя метод ПолучитьСуммуНакопления.
//
// Параметры:
//  МассивКарт - Массив -   массив содержащий ссылки на дисконтные карты
//						используется только одна первая карта.
//  СтруктураПараметров - Структура - структура, содержащая дополнительные параметры для запроса.
//  ЕстьОшибки - Булево - признак того, что при обращении к дисконтному серверу возникли ошибки.
//
// Возвращаемое значение:
//  Структура - структура, содержащая Дату запроса и значения накоплений в свойствах "Сумма" и "Количество".
//
...
//
// Параметры:
//  ДисконтнаяКарта - Массив - массив, содержащий ссылки на дисконтные карты
//  						   используется только одна первая карта.
//  СтруктураПараметров - Структура - структура, содержащая дополнительные параметры для запроса.
//  ЕстьОшибки - Булево - признак того, что при обращении к дисконтному серверу возникли ошибки.
//
// Возвращаемое значение:
//  Структура - структура содержащая накопления в свойстве "КоличествоБонусов".
//
...
//  						  используется только одна первая карта.
//  СтруктураПараметров - Структура - структура, содержащая дополнительные параметры для запроса.
//  ЕстьОшибки - Булево - булево, Признак того, что при обращении к дисконтному серверу возникли ошибки.
//
// Возвращаемое значение:
...
//
// Возвращаемое значение:
//  Структура - структура, содержащая Дату последней покупки
...
// Создает WSПрокси дисконтного сервера
...
// Подготавливает структуру параметров
// которая используется при получении данных о накоплениях по карте.
// 
// Возвращаемое значение:
//  Структура - структура параметров для получения данных о накоплениях по карте.
//
...
// 
// Возвращаемое значение:
//  Структура - структура параметров для получения данных о накопленных по карте бонусах.
//
...
// Обновляет данные о продажах в дисконтном сервере
// для чего используется вызов метода "ОбновитьДанныеОПродажах".
//
// Параметры:
//  ДокументСсылка - документ по которому обновляются данные в дисконтном сервере.
//  ЕстьОшибки - Булево - признак наличия ошибок при выполнении функции.
// 
// Возвращаемое значение:
...
// Записывает задание о необходимости обновления
...
//
// Параметры:
//  ДокументСсылка - документ по которому необходимо записать задание об обновлении
//                   данных о продажах в дисконтном сервере.
//  ВыгрузкаУжеБыла - Булево - признак была ли осуществлена выгрузка.
//
...
// Выбирает все задания для передачи дисконтному серверу 
...
// Параметры:
//  КодКупона - Строка - код купона для формирования запроса к дисконтному серверу.
//  ДатаЗапроса - ДатаВремя - дата, на которую получается срез последних.
// Возвращаемое значение:
//  ТаблицаЗначений - таблица, содержащая сведения среза последних состояний однократных скидок по указанному купону.
//
...
// Возвращает объект по переданному идентификатору.
//
// Параметры:
//  ИдентификаторОбъекта - УникальныйИдентификатор - уникальный идентификатор объекта.
//  ТипОбъекта - Строка - наименование типа объекта.
//  КлассОбъекта - Строка - класс объекта метаданных.
//
// ВозвращаемоеЗначение:
//  Объект - возвращает объект по ссылке.
//

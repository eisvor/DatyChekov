...
Процедура ОпределитьВидОперацииПродажа(ЭтоОперацияПродажи, ВидОперации) Экспорт
	...
	ОбщегоНазначенияРМКРТКлиент.ОпределитьВидОперацииПродажа(ЭтоОперацияПродажи, ВидОперации);
...
Процедура ОпределитьВидОперацииВозвратПродажи(ЭтоОперацияВозвратПродажи, ВидОперации) Экспорт
	...
	ОбщегоНазначенияРМКРТКлиент.ОпределитьВидОперацииВозвратПродажи(ЭтоОперацияВозвратПродажи, ВидОперации);
...
Процедура ОпределитьВидОперацииСкупка(ЭтоОперацияСкупка, ВидОперации) Экспорт
	...
	ОбщегоНазначенияРМКРТКлиент.ОпределитьВидОперацииСкупка(ЭтоОперацияСкупка, ВидОперации);
...
Процедура ОпределитьВидОперацииВозвратСкупки(ЭтоОперацияВозвратСкупки, ВидОперации) Экспорт
	...
	ОбщегоНазначенияРМКРТКлиент.ОпределитьВидОперацииВозвратСкупки(ЭтоОперацияВозвратСкупки, ВидОперации);
...
Процедура ОпределитьВидОплатыНаличные(ЭтоОплатаНаличными, ВидОплаты) Экспорт
	...
	ОбщегоНазначенияРМКРТКлиент.ОпределитьВидОплатыНаличные(ЭтоОплатаНаличными, ВидОплаты);
...
Процедура ОпределитьВидОплатыПлатежнаяКарта(ЭтоОплатаПлатежнойКартой, ВидОплаты) Экспорт
	...
	ОбщегоНазначенияРМКРТКлиент.ОпределитьВидОплатыПлатежнаяКарта(ЭтоОплатаПлатежнойКартой, ВидОплаты);
...
Процедура ОпределитьВидОплатыЗачетАванса(ЭтоОплатаЗачетАванса, ВидОплаты) Экспорт
	...
	ОбщегоНазначенияРМКРТКлиент.ОпределитьВидОплатыЗачетАванса(ЭтоОплатаЗачетАванса, ВидОплаты);
...
Процедура ОпределитьВидОплатыБезналичные(ЭтоОплатаБезналичные, ВидОплаты) Экспорт
	...
	ОбщегоНазначенияРМКРТКлиент.ОпределитьВидОплатыБезналичные(ЭтоОплатаБезналичные, ВидОплаты);
...
Процедура ОпределитьВидОплатыВРассрочку(ЭтоОплатаВРассрочку, ВидОплаты) Экспорт
	...
	ОбщегоНазначенияРМКРТКлиент.ОпределитьВидОплатыВРассрочку(ЭтоОплатаВРассрочку, ВидОплаты);
...
Процедура ОпределитьВидОплатыВстречнымПредоставлением(ЭтоОплатаВстречнымПредоставлением, ВидОплаты) Экспорт
	ОбщегоНазначенияРМКРТКлиент.ОпределитьВидОплатыВстречнымПредоставлением(ЭтоОплатаВстречнымПредоставлением, ВидОплаты);
КонецПроцедуры
...
Процедура ОпределитьВидОплатыПлатежнаяКартаНСПК(ВидОплатыПлатежнаяКартаНСПК) Экспорт
	...
	ОбщегоНазначенияРМКРТКлиент.ОпределитьВидОплатыПлатежнаяКартаНСПК(ВидОплатыПлатежнаяКартаНСПК);
...
Процедура ОпределитьВидОплатыКредитом(ЭтоОплатаКредитом, ВидОплаты) Экспорт
	...
	ОбщегоНазначенияРМКРТКлиент.ОпределитьВидОплатыКредитом(ЭтоОплатаКредитом, ВидОплаты);
...
Процедура ОпределитьВидОплатыПодарочнымСертификатом(ЭтоОплатаПодарочнымСертификатом, ВидОплаты) Экспорт
	...
	ОбщегоНазначенияРМКРТКлиент.ОпределитьВидОплатыПодарочнымСертификатом(ЭтоОплатаПодарочнымСертификатом, ВидОплаты);
...
Процедура ОпределитьТипНоменклатурыТовар(ТипНоменклатуры) Экспорт
	...
	ОбщегоНазначенияРМКРТКлиент.ОпределитьТипНоменклатурыТовар(ТипНоменклатуры);
...
Процедура ОпределитьТипНоменклатурыПодарочныйСертификат(ТипНоменклатуры) Экспорт
	...
	ОбщегоНазначенияРМКРТКлиент.ОпределитьТипНоменклатурыПодарочныйСертификат(ТипНоменклатуры);
...
Процедура ОпределитьОсобенностьУчетаАлкоголь(ОсобенностьУчета) Экспорт
	...
	ОбщегоНазначенияРМКРТКлиент.ОпределитьОсобенностьУчетаАлкоголь(ОсобенностьУчета);
...
Процедура ОпределитьОсобенностьУчетаГИСМ(ОсобенностьУчета) Экспорт
	...
	ОбщегоНазначенияРМКРТКлиент.ОпределитьОсобенностьУчетаГИСМ(ОсобенностьУчета);
...
Процедура ОпределитьОсобенностьУчетаТабак(ОсобенностьУчета) Экспорт
	...
	ОбщегоНазначенияРМКРТКлиент.ОпределитьОсобенностьУчетаТабак(ОсобенностьУчета);
...
Процедура СформироватьПечатнуюФормуТоварногоЧека(ЧекККМ, Форма) Экспорт
	...
	ОбщегоНазначенияРМКРТКлиент.СформироватьПечатнуюФормуТоварногоЧека(ЧекККМ, Форма);
	
КонецПроцедуры

Процедура СформироватьПечатнуюФормуЗаказаПокупателя(Заказ, Форма) Экспорт
	
	ОбщегоНазначенияРМКРТКлиент.СформироватьПечатнуюФормуЗаказаПокупателя(Заказ, Форма);
...
Процедура ОткрытьИнтерфейсПодбораНоменклатуры(ЭтотОбъект, Параметры, ОповещениеОВыборе) Экспорт
	...
	ОбщегоНазначенияРМКРТКлиент.ОткрытьИнтерфейсПодбораНоменклатуры(ЭтотОбъект, Параметры, ОповещениеОВыборе);
...
Процедура ЗаполнитьПараметрыОткрытияФормыПодбораВСоставПалитрыТоваров(Параметры) Экспорт
	ОбщегоНазначенияРМКРТКлиент.ЗаполнитьПараметрыОткрытияФормыПодбораВСоставПалитрыТоваров(Параметры);
КонецПроцедуры
...
Процедура ЗаполнитьПараметрыОткрытияФормыПечатиДокументовДляТоварногоЧека(ЧекККМ, ПараметрыОткрытия,
	...
	ОбщегоНазначенияРМКРТКлиент.ЗаполнитьПараметрыОткрытияФормыПечатиДокументовДляТоварногоЧека(ЧекККМ,
...
Процедура ВыполнитьОперациюВыемка(Форма, ДополнительныеПараметры) Экспорт
	...
	ОбщегоНазначенияРМКРТКлиент.ВыполнитьОперациюВыемка(Форма, ДополнительныеПараметры);
...
Процедура ПроверитьЗаполнениеОплатПередПробитиемЧека(ОплатаЗаполненаВерно, СтруктураОшибки, Форма, СтандартнаяОбработка) Экспорт
	...
	ОбщегоНазначенияРМКРТКлиент.ПроверитьЗаполнениеОплатПередПробитиемЧека(ОплатаЗаполненаВерно, СтруктураОшибки, Форма, СтандартнаяОбработка);
...
Процедура ОткрытьСписокЧековСОшибкамиНСПК(Форма, ОповещениеОЗакрытии) Экспорт
	...
	ОбщегоНазначенияРМКРТКлиент.ОткрытьСписокЧековСОшибкамиНСПК(Форма, ОповещениеОЗакрытии);
...
Процедура ЗаполнитьВидОперацииЧекаККМ(ПараметрыВидаОперации) Экспорт
	...
	ОбщегоНазначенияРМКРТКлиент.ЗаполнитьВидОперацииЧекаККМ(ПараметрыВидаОперации);
...
Процедура ЗаполнитьДанныеТекущегоЭквайринговогоТерминала(Форма, ДанныеЭТ) Экспорт
	...
	ОбщегоНазначенияРМКРТКлиент.ЗаполнитьДанныеТекущегоЭквайринговогоТерминала(Форма, ДанныеЭТ);
...
Процедура ЗаполнитьДанныеТекущихЭквайринговыхТерминалов(Форма, Результат) Экспорт
	...
	ОбщегоНазначенияРМКРТКлиент.ЗаполнитьДанныеТекущихЭквайринговыхТерминалов(Форма, Результат);
...
Процедура ЗаполнитьДанныеОплатКартойПоЧеку(Форма, Результат) Экспорт
	...
	ОбщегоНазначенияРМКРТКлиент.ЗаполнитьДанныеОплатКартойПоЧеку(Форма, Результат);
...
Процедура ЗаполнитьПризнакСтандартныйИнтерфейсВнесения(Результат) Экспорт
	...
	ОбщегоНазначенияРМКРТКлиент.ЗаполнитьПризнакСтандартныйИнтерфейсВнесения(Результат);
...
Процедура ЗаполнитьПризнакИспользованияВнешнегоСобытия(Результат) Экспорт
	...
	ОбщегоНазначенияРМКРТКлиент.ЗаполнитьПризнакИспользованияВнешнегоСобытия(Результат);
...
Процедура ПроверитьОшибкиЗаполненияКартыЛояльности(Форма, ЕстьОшибки, СтандартнаяОбработка = Истина) Экспорт
	...
	ОбщегоНазначенияРМКРТКлиент.ПроверитьОшибкиЗаполненияКартыЛояльности(Форма, ЕстьОшибки);
...
Процедура ЗаполнитьПризнакСоздаватьЛокальноКартуЛояльности(Результат) Экспорт
	...
	ОбщегоНазначенияРМКРТКлиент.ЗаполнитьПризнакСоздаватьЛокальноКартуЛояльности(Результат);
...
Процедура ЗаполнитьПризнакИспользоватьПоискСертификатаЛокально(Результат) Экспорт
	...
	ОбщегоНазначенияРМКРТКлиент.ЗаполнитьПризнакИспользоватьПоискСертификатаЛокально(Результат);
...
Процедура ЗаполнитьПризнакИспользоватьЗапросБонусовЛокально(Результат) Экспорт
	...
	ОбщегоНазначенияРМКРТКлиент.ЗаполнитьПризнакИспользоватьЗапросБонусовЛокально(Результат);
...
Процедура ЗаполнитьПризнакЭтоДокументБезналичнойОплаты(ДокументСсылка, ЭтоДокументБезналичнойОплаты) Экспорт
	...
	ОбщегоНазначенияРМКРТКлиент.ЗаполнитьПризнакЭтоДокументБезналичнойОплаты(ДокументСсылка, ЭтоДокументБезналичнойОплаты);
...
Процедура ОбработатьВыбранноеЗначениеКодаДоступа(Форма, ВыбранноеЗначение, СтандартнаяОбработка) Экспорт
	ОбщегоНазначенияРМКРТКлиент.ОбработатьВыбранноеЗначениеКодаДоступа(Форма,
		ВыбранноеЗначение,
		СтандартнаяОбработка);
КонецПроцедуры
...
Процедура ЗаполнитьМассивОсобенностейДляВозвратаБезМарки(МассивОсобенностей) Экспорт
	...
	ОбщегоНазначенияРМКРТКлиент.ЗаполнитьМассивОсобенностейДляВозвратаБезМарки(МассивОсобенностей);
...
Процедура ПроверитьНеобходимостьЗаполненияКонтрагента(Результат) Экспорт
	...
	ОбщегоНазначенияРМКРТКлиент.ПроверитьНеобходимостьЗаполненияКонтрагента(Результат);
...
Процедура ЗаполнитьПодтверждениеМаркиАлкоголя(НужноПодтверждениеМаркиАлкоголя) Экспорт
	...
	ОбщегоНазначенияРМКРТКлиент.ЗаполнитьПодтверждениеМаркиАлкоголя(НужноПодтверждениеМаркиАлкоголя);
...
Процедура ЗаполнитьПризнакИспользованияАвтоматическихСкидок(Результат) Экспорт
	ОбщегоНазначенияРМКРТКлиент.ЗаполнитьПризнакИспользованияАвтоматическихСкидок(Результат);
КонецПроцедуры
...
Процедура РазблокироватьОбъектСервераЛояльности(ТипОбъекта, ПараметрыОбъекта) Экспорт
	...
	ОбщегоНазначенияРМКРТВызовСервера.РазблокироватьОбъектСервераЛояльности(ТипОбъекта, ПараметрыОбъекта);
...
Процедура ОткрытьФормуОплатыКредитом(Форма) Экспорт
	...
	ОбщегоНазначенияРМКРТКлиент.ОткрытьФормуОплатыКредитом(Форма);
...
Процедура ОпределитьНеобходимостьЗапросаБалансаСертификата(ЗапрашиватьБаланс) Экспорт
	ОбщегоНазначенияРМКРТКлиент.ОпределитьНеобходимостьЗапросаБалансаСертификата(ЗапрашиватьБаланс);
КонецПроцедуры
...
Процедура ОткрытьФормуВыбораКонтрагента(СтруктураПараметров, СтандартнаяОбработка) Экспорт
	ОбщегоНазначенияРМКРТКлиент.ОткрытьФормуВыбораКонтрагента(СтруктураПараметров, СтандартнаяОбработка);
КонецПроцедуры
...
Процедура ОткрытьФормуНастройкиЭквайринга(СтруктураПараметров, СтандартнаяОбработка) Экспорт
	ОбщегоНазначенияРМКРТКлиент.ОткрытьФормуНастройкиЭквайринга(СтруктураПараметров, СтандартнаяОбработка);
КонецПроцедуры
...
Процедура НастроитьЭлементыВидовОплат(СтруктураПараметров, СтандартнаяОбработка) Экспорт
	ОбщегоНазначенияРМКРТКлиент. НастроитьЭлементыВидовОплат(СтруктураПараметров, СтандартнаяОбработка);
КонецПроцедуры
...
Процедура ИнициализироватьФормуРабочегоМестаКассира(Форма) Экспорт
	...
	ОбщегоНазначенияРМКРТКлиент.ИнициализироватьФормуРабочегоМестаКассира(Форма);
...
Процедура ПодключитьКегКОборудованиюРозлива(Форма, ТекущаяСтрока, ОповещениеОЗавершении) Экспорт
	ОбщегоНазначенияРМКРТКлиент.ПодключитьКегКОборудованиюРозлива(Форма, ТекущаяСтрока, ОповещениеОЗавершении);
КонецПроцедуры
...
Процедура ОтключитьКегОтОборудованияРозлива(Форма, ОповещениеОЗавершении) Экспорт
	ОбщегоНазначенияРМКРТКлиент.ОтключитьКегОтОборудованияРозлива(Форма, ОповещениеОЗавершении);
КонецПроцедуры
...
Процедура ДополнитьИменаРеквизитовОбъектаФормыРМКДляДобавленияСтроки(ИменаРеквизитов) Экспорт
	ОбщегоНазначенияРМКРТКлиент.ДополнитьИменаРеквизитовОбъектаФормыРМКДляДобавленияСтроки(ИменаРеквизитов);
КонецПроцедуры
...
Процедура ДополнитьИменаРеквизитовФормыРМКДляДобавленияСтроки(ИменаРеквизитов) Экспорт
	ОбщегоНазначенияРМКРТКлиент.ДополнитьИменаРеквизитовФормыРМКДляДобавленияСтроки(ИменаРеквизитов);
КонецПроцедуры
...
Процедура ДополнитьИменаРеквизитовТекущейСтрокиФормыРМКДляДобавленияСтроки(ИменаРеквизитов) Экспорт
	ОбщегоНазначенияРМКРТКлиент.ДополнитьИменаРеквизитовТекущейСтрокиФормыРМКДляДобавленияСтроки(ИменаРеквизитов);
КонецПроцедуры
...
Процедура ОпределитьСуществованиеПодсистемыГосИС(Форма, Результат) Экспорт
	...
	ОбщегоНазначенияРМКРТКлиент.ОпределитьСуществованиеПодсистемыГосИС(Форма, Результат); // НЕ РМК
...
Процедура ВывестиПредупреждениеОстаткаЧастичноеВыбытие(ТекущаяСтрока, СтандартнаяОбработка) Экспорт
	ОбщегоНазначенияРМКРТКлиент.ВывестиПредупреждениеОстаткаЧастичноеВыбытие(ТекущаяСтрока, СтандартнаяОбработка);
КонецПроцедуры
...
Процедура УстановитьВидимостьИндикатораОстатка(ТекущаяСтрока, ЭлементИндикатора, СтандартнаяОбработка) Экспорт
	ОбщегоНазначенияРМКРТКлиент.УстановитьВидимостьИндикатораОстатка(ТекущаяСтрока, ЭлементИндикатора, СтандартнаяОбработка);
КонецПроцедуры
...
Процедура ВскрытьПотребительскуюУпаковку(Форма, ТекущаяСтрока, ОповещениеОЗавершении) Экспорт
	...
	ОбщегоНазначенияРМКРТКлиент.ВскрытьПотребительскуюУпаковку(Форма, ТекущаяСтрока, ОповещениеОЗавершении);
...
Процедура ЗаполнитьДополнительныеДанныеДляПробитияЧека(Форма, ДополнительныеДанные) Экспорт
	...
	ОбщегоНазначенияРМКРТКлиент.ЗаполнитьДополнительныеДанныеДляПробитияЧека(Форма, ДополнительныеДанные);
...
Процедура ОбновитьРеквизитыФормыПослеПодготовкиДанныхДляЧека(Форма, ДополнительныеДанные) Экспорт
	...
	ОбщегоНазначенияРМКРТКлиент.ОбновитьРеквизитыФормыПослеПодготовкиДанныхДляЧека(Форма, ДополнительныеДанные);

...
Процедура ИспользоватьСерверЛояльности(Ответ, Результат) Экспорт
	...
	СерверЛояльностиПоставщикДанныхРТ.ИспользоватьСерверЛояльности(Ответ, Результат);
...
Процедура ЗаполнитьБонуснуюПрограммуПоДисконтнойКарте(ДисконтнаяКарта, БонуснаяПрограммаЛояльности) Экспорт
	...
	СерверЛояльностиПоставщикДанныхРТ.ЗаполнитьБонуснуюПрограммуПоДисконтнойКарте(ДисконтнаяКарта, БонуснаяПрограммаЛояльности);
...
Процедура ЗаполнитьДанныеОБонусах(ДисконтнаяКарта, СтруктураОтвета) Экспорт
	...
	СерверЛояльностиПоставщикДанныхРТ.ЗаполнитьДанныеОБонусах(ДисконтнаяКарта, СтруктураОтвета);
...
Процедура ОбработкаСостоянияБонусов() Экспорт
	...
	СерверЛояльностиПоставщикДанныхРТ.ОбработкаСостоянияБонусов();
...
Процедура ПолучитьКодВалюты(КодВалюты = "") Экспорт
	...
	СерверЛояльностиПоставщикДанныхРТ.ПолучитьКодВалюты(КодВалюты);
...
Процедура НайтиКартуКлиента(ПараметрыМетода, Результат = Неопределено) Экспорт
	...
	СерверЛояльностиПоставщикДанныхРТ.НайтиКартуКлиента(ПараметрыМетода, Результат);
...
Процедура СоздатьКартуКлиента(ДанныеКарты, Результат = Неопределено, ДругойКлиент = Неопределено, ОписаниеОшибки = "") Экспорт
	...
	СерверЛояльностиПоставщикДанныхРТ.СоздатьКартуКлиента(ДанныеКарты, Результат, ДругойКлиент);
...
Процедура ЗаполнитьСтруктуруОтветаДаннымиКарты(ДисконтнаяКарта, СтруктураОтвета, КартаСуществует = Ложь) Экспорт 
	...
	СерверЛояльностиПоставщикДанныхРТ.ЗаполнитьСтруктуруОтветаДаннымиКарты(ДисконтнаяКарта, СтруктураОтвета, КартаСуществует);
...
Процедура ЗаполнитьСтруктуруОтветаДаннымиКлиента(Клиент, СтруктураОтвета) Экспорт
	...
	СерверЛояльностиПоставщикДанныхРТ.ЗаполнитьСтруктуруОтветаДаннымиКлиента(Клиент, СтруктураОтвета);
...
Процедура НайтиПодарочныйСертификат(ПараметрыМетода, Результат) Экспорт
	...
	СерверЛояльностиПоставщикДанныхРТ.НайтиПодарочныйСертификат(ПараметрыМетода, Результат);
...
Процедура ПолучитьБалансПодарочногоСертификата(ДанныеСертификата, СтруктураОтвета) Экспорт
	...
	СерверЛояльностиПоставщикДанныхРТ.ПолучитьБалансПодарочногоСертификата(ДанныеСертификата, СтруктураОтвета);
...
Процедура ЗаполнитьПараметрыШаблонаКарты(ДанныеКарты, СтруктураШаблона) Экспорт
	...
	СерверЛояльностиПоставщикДанныхРТ.ЗаполнитьПараметрыШаблонаКарты(ДанныеКарты, СтруктураШаблона);
...
Процедура ИспользоватьАвтоматическиеСкидки(Результат) Экспорт
	...
	СерверЛояльностиПоставщикДанныхРТ.ИспользоватьАвтоматическиеСкидки(Результат);
...
Процедура РассчитатьАвтоматическиеСкидки(ПараметрыРасчета, Результат) Экспорт
	...
	СерверЛояльностиПоставщикДанныхРТ.РассчитатьАвтоматическиеСкидки(ПараметрыРасчета, Результат);
...
Процедура ДесериализоватьПараметрыРасчета(ВходящиеДанные, Результат) Экспорт
	...
	СерверЛояльностиПоставщикДанныхРТ.ДесериализоватьПараметрыРасчета(ВходящиеДанные, Результат);
...
Процедура ПроверитьПодарочныйСертификат(ПараметрыМетода, СтруктураОтвета) Экспорт
	...
	СерверЛояльностиПоставщикДанныхРТ.ПроверитьПодарочныйСертификат(ПараметрыМетода, СтруктураОтвета);
...
Процедура ПроверитьИспользованиеПодарочныхСертификатов(Результат) Экспорт
	...
	СерверЛояльностиПоставщикДанныхРТ.ПроверитьИспользованиеПодарочныхСертификатов(Результат);
...
Процедура ДанныеОЗапретахПродаж(ПараметрыМетода, Результат) Экспорт
	...
	СерверЛояльностиПоставщикДанныхРТ.ДанныеОЗапретахПродаж(ПараметрыМетода, Результат);
...
Процедура ЗаполнитьИменаРеквизитовПоставщикаДанных(ИменаРеквизитов) Экспорт
	...
	СерверЛояльностиПоставщикДанныхРТ.ЗаполнитьИменаРеквизитовПоставщикаДанных(ИменаРеквизитов);
...
Процедура ЗаполнитьТаблицуСкидокЗависящихОтВидаОплаты(Результат) Экспорт
	...
	СерверЛояльностиПоставщикДанныхРТ.ЗаполнитьТаблицуСкидокЗависящихОтВидаОплаты(Результат);
...
Процедура ПараметрыИзЗапросаПолучитьОстатки(ВходящиеДанные, Результат) Экспорт
	...
	СерверЛояльностиПоставщикДанныхРТ.ПараметрыИзЗапросаПолучитьОстатки(ВходящиеДанные, Результат);
...
Процедура ПолучитьОстатки(ПараметрыМетода, СтруктураОтвета) Экспорт
	...
	СерверЛояльностиПоставщикДанныхРТ.ПолучитьОстатки(ПараметрыМетода, СтруктураОтвета);
...
Процедура НайтиКартыЛояльности(ПараметрыМетода, СтруктураОтвета) Экспорт
	...
	СерверЛояльностиПоставщикДанныхРТ.НайтиКартыЛояльности(ПараметрыМетода, СтруктураОтвета);
...
Процедура ПолучитьКартуКлиентаПоУникальномуИдентификатору(СтрокаУникальногоИдентификатора, КартаКлиента) Экспорт
	...
	СерверЛояльностиПоставщикДанныхРТ.ПолучитьКартуКлиентаПоУникальномуИдентификатору(СтрокаУникальногоИдентификатора,
		КартаКлиента);
...
Процедура ЗаполнитьСтруктуруОтветаНомерамиКарты(КартаКлиента, СтруктураОтвета) Экспорт
	...
	СерверЛояльностиПоставщикДанныхРТ.ЗаполнитьСтруктуруОтветаНомерамиКарты(КартаКлиента, СтруктураОтвета);
...
Процедура ЗаполнитьТаблицуВидовКарт(Результат, ПараметрыРасчета) Экспорт
	...
	СерверЛояльностиПоставщикДанныхРТ.ЗаполнитьТаблицуВидовКарт(Результат);
...
Процедура ЗаполнитьДанныеОбОборотахПродаж(ДисконтнаяКарта, СтруктураОтвета) Экспорт
	...
	СерверЛояльностиПоставщикДанныхРТ.ЗаполнитьДанныеОбОборотахПродаж(ДисконтнаяКарта, СтруктураОтвета);
...
Процедура ПараметрыМетодаИзЗапросаОбъединитьБонусныеКарты(ВходящиеДанные, Результат) Экспорт
	...
	СерверЛояльностиПоставщикДанныхРТ.ПараметрыМетодаИзЗапросаОбъединитьБонусныеКарты(ВходящиеДанные, Результат);
...
Процедура ОбъединитьБонусныеКарты(ПараметрыМетода, СтруктураОтвета) Экспорт
	...
	СерверЛояльностиПоставщикДанныхРТ.ОбъединитьБонусныеКарты(ПараметрыМетода, СтруктураОтвета);

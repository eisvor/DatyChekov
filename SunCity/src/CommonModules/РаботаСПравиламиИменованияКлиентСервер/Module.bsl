////////////////////////////////////////////////////////////////////////////////
// РаботаСПравиламиИменованияКлиентСервер содержит процедуры и функции для работы 
...
//  Строка - преобразованная по правилу именования строка.
//
...
//  Строка - недопустимые символы в имени.
//
Функция НедопустимыеСимволыВИмениПараметра() Экспорт
...
//
// Возвращаемое значение:
//  Строка - измененное имя параметра.
//
...
//
// Возвращаемое значение:
//  Массив - найденные недопустимые символы.
//
Функция НайтиНедопустимыеСимволыВИмениПараметра(ИмяПараметра) Экспорт

	НедопустимыеСимволы = НедопустимыеСимволыВИмениПараметра();
...
//
// Возвращаемое значение:
//  Структура - структура правила именования.
//
...
Процедура ПроверитьБалансСкобок(СтруктураПравила)
	...
	Если ОшибкаБалансаРазделителей Тогда
		...
		СтруктураПравила.ЕстьОшибки = Истина;
		СтруктураПравила.ОписаниеОшибок.Добавить(НСтр("ru = 'Некорректно расставлены квадратные скобки;'"));
...
//
// Параметры:
//	СтруктураПравила - Структура - см. РаботаСПравиламиИменованияКлиент.ПолучитьПустуюСтруктуруПравилаИменования
//

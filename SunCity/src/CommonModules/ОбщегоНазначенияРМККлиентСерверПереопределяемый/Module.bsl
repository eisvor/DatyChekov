...
Процедура ЗаполнитьДанныеДополненияПредупреждения(ДанныеДополненияПредупреждения) Экспорт
	ОбщегоНазначенияРМКРТКлиентСервер.ЗаполнитьДанныеДополненияПредупреждения(ДанныеДополненияПредупреждения);
КонецПроцедуры
...
Процедура ЗаполнитьДеньНеделиПеречислением(Результат, Дата) Экспорт
	ОбщегоНазначенияРМКРТКлиентСервер.ЗаполнитьДеньНеделиПеречислением(Результат, Дата);
КонецПроцедуры
...
Процедура ПереопределитьВидОтображенияНастроек(ВидОтображения) Экспорт
	ОбщегоНазначенияРМКРТКлиентСервер.ПереопределитьВидОтображенияНастроек(ВидОтображения);
КонецПроцедуры
...
Процедура ПереопределитьПоложениеЗаголовкаНастроек(ПоложениеЗаголовка) Экспорт
	ОбщегоНазначенияРМКРТКлиентСервер.ПереопределитьПоложениеЗаголовкаНастроек(ПоложениеЗаголовка);
КонецПроцедуры
...
Процедура ЗаполнитьТекстОшибкиПриОпределенииКассы(ТекстСообщения) Экспорт
	ОбщегоНазначенияРМКРТКлиентСервер.ЗаполнитьТекстОшибкиПриОпределенииКассы(ТекстСообщения);
КонецПроцедуры
...
Процедура ЗаполнитьТекстОшибкиПриОпределенииНастройкиРМК(ТекстСообщения) Экспорт
	ОбщегоНазначенияРМКРТКлиентСервер.ЗаполнитьТекстОшибкиПриОпределенииНастройкиРМК(ТекстСообщения);
КонецПроцедуры
...
Процедура ЗаполнитьЗаголовокОсобенностьУчета(Заголовок) Экспорт
	ОбщегоНазначенияРМКРТКлиентСервер.ЗаполнитьЗаголовокОсобенностьУчета(Заголовок);
КонецПроцедуры
...
Процедура ЗаполнитьЗаголовокВидНоменклатуры(Заголовок) Экспорт
	ОбщегоНазначенияРМКРТКлиентСервер.ЗаполнитьЗаголовокВидНоменклатуры(Заголовок);
КонецПроцедуры
...
Процедура ОпределитьОсобенностьУчетаПивнаяПродукция(ОсобенностьУчета, Результат) Экспорт
	ОбщегоНазначенияРМКРТКлиентСервер.ОпределитьОсобенностьУчетаПивнаяПродукция(ОсобенностьУчета, Результат);
КонецПроцедуры
...
Процедура ВыводитьОстатокВПредставлении(ВыводитьОстатокВПредставлении) Экспорт
	ОбщегоНазначенияРМКРТКлиентСервер.ВыводитьОстатокВПредставлении(ВыводитьОстатокВПредставлении);
КонецПроцедуры

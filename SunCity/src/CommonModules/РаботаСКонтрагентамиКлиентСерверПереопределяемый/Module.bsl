...
Процедура ОпределитьВидДокумента(Форма, Результат) Экспорт
	...
	РаботаСКонтрагентамиКлиентСерверРТ.ОпределитьВидДокумента(Форма, Результат);
...
Процедура ПолучитьСчетФактуру(Форма, СчетФактура) Экспорт
	...
	РаботаСКонтрагентамиКлиентСерверРТ.ПолучитьСчетФактуру(Форма, СчетФактура);
...
Процедура ПриОпределенииОбъектаИСсылкиПоФорме(Форма, Результат) Экспорт
	...
	РаботаСКонтрагентамиКлиентСерверРТ.ПриОпределенииОбъектаИСсылкиПоФорме(Форма, Результат);

...
Процедура ПриОпределенииОбщихПараметровБазовойФункциональности(ОбщиеПараметры) Экспорт
	...
	ОбщиеПараметры.РекомендуемыйОбъемОперативнойПамяти = 1;
...
Процедура ПриДобавленииОбработчиковУстановкиПараметровСеанса(Обработчики) Экспорт
	...
	Обработчики.Вставить("ОбщиеЗначения",                     "ОбщегоНазначенияРТ.УстановитьПараметрыСеанса");
	Обработчики.Вставить("ТекущийМагазин",                    "ОбщегоНазначенияРТ.УстановитьПараметрыСеанса");
	Обработчики.Вставить("ФормаРабочегоМестаКассира",         "ОбщегоНазначенияРТ.УстановитьПараметрыСеанса");
	Обработчики.Вставить("ИспользуемыеПланыОбмена",           "ОбщегоНазначенияРТ.УстановитьПараметрыСеанса");
...
Процедура ПриДобавленииПараметровРаботыКлиентаПриЗапуске(Параметры) Экспорт
	...
	Параметры.Вставить("ТекущийМагазин", ОбщегоНазначенияРТ.ОпределитьТекущийМагазин());
...
Процедура ПриПолученииДанныхОтГлавного(Источник, ЭлементДанных, ПолучениеЭлемента, ОтправкаНазад) Экспорт
	...
	Если НЕ Источник = Неопределено И 
		(ТипЗнч(Источник) = Тип("ПланОбменаОбъект.ОбменРозницаРозница")
		ИЛИ ТипЗнч(Источник) = Тип("ПланОбменаОбъект.ОбменСУРМК"))Тогда
		Источник.ПриПолученииДанных(ЭлементДанных, ПолучениеЭлемента);
	КонецЕсли;

...
Процедура ПередЗаполнениемПоставляемыхПриложений(ПараметрыПоставляемыхПриложений) Экспорт
	...
	УправлениеМобильнымиПриложениямиРТ.ПараметрыПоставляемыхПриложений(ПараметрыПоставляемыхПриложений);
...
Процедура ПослеЗаписиНастройки(УзелОбмена, СтандартнаяОбработка) Экспорт
	...
	УправлениеМобильнымиПриложениямиРТ.ПослеЗаписиНастройки(УзелОбмена, СтандартнаяОбработка);
...
Процедура ПриИзмененииОбязательнойНастройки(ИмяНастройки, КомпоновщикНастроек) Экспорт
	...
	УправлениеМобильнымиПриложениямиРТ.ПриИзмененииОбязательнойНастройки(ИмяНастройки, КомпоновщикНастроек);
...
Процедура ПриИзмененииТаблицыНастроек(Форма, КомпоновщикНастроек) Экспорт
	...
	УправлениеМобильнымиПриложениямиРТ.ПриИзмененииТаблицыНастроек(Форма, КомпоновщикНастроек);
...
Процедура ПриОпределенииНастроекПриложения(МобильноеПриложение, НастройкиПриложения) Экспорт
	...
	УправлениеМобильнымиПриложениямиРТ.ПриОпределенииНастроекПриложения(МобильноеПриложение, НастройкиПриложения);
...
Процедура ПриОпределенииВерсииФорматаОбмена(ВерсияФорматаОбмена, МобильноеПриложение) Экспорт
	...
	УправлениеМобильнымиПриложениямиРТ.ПриОпределенииВерсииФорматаОбмена(ВерсияФорматаОбмена, МобильноеПриложение);
...
Процедура ПриОпределенииСпискаВыбораНаименования(Форма, Наименование, МобильноеПриложение, НастройкиПриложения) Экспорт
	...
	УправлениеМобильнымиПриложениямиРТ.ПриОпределенииСпискаВыбораНаименования(
...
Процедура ПриОпределенииСпискаМобильныхПриложений(СписокПриложений, СтандартнаяОбработка) Экспорт
	...
	УправлениеМобильнымиПриложениямиРТ.ПриОпределенииСпискаМобильныхПриложений(
...
Процедура ПриПолученииИконкиПриложения(МобильноеПриложение, ДвоичныеДанныеИконки) Экспорт
	...
	УправлениеМобильнымиПриложениямиРТ.ПриПолученииИконкиПриложения(
...
Процедура ПриПолученииСсылкиНаСкачивание(МобильноеПриложение, УникальныйИдентификатор, АдресСсылкиGooglePlay) Экспорт
	...
	УправлениеМобильнымиПриложениямиРТ.ПриПолученииСсылкиНаСкачивание(
...
Процедура ПриПолученииСхемыКомпоновкиНастроек(МобильноеПриложение, СхемаКомпоновки) Экспорт
	...
	УправлениеМобильнымиПриложениямиРТ.ПриПолученииСхемыКомпоновкиНастроек(

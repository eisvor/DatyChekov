////////////////////////////////////////////////////////////////////////////////
// КомпоновкаДанныхКлиентСервер содержит процедуры и функции 
// для работы с компоновками данных.
//  
////////////////////////////////////////////////////////////////////////////////
...
//         ВыбранныеПоляКомпоновкиДанных - место добавления выбранного поля компоновки данных.
//  ИмяИлиПолеКД - Строка,
//                 ПолеКомпоновкиДанных - имя поля или поле компоновки данных для добавления.
//  Заголовок - Строка - заголовок поля компоновки данных.
//
// Возвращаемое значение:
//  ВыбранноеПолеКомпоновкиДанных - выбранное поле КД.
//
...
//  Поле - Строка,
//         ПолеКомпоновкиДанных - имя или поле КД.
...
//  ЭлементСтруктурыТаблицыКомпоновкиДанных,
//  ЭлементСтруктурыДиаграммыКомпоновкиДанных
//  ГруппировкаКомпоновкиДанных - добавляемая группировка в компоновщик.
//
...
// Добавляет группировку в компоновщик настроек в корневой уровень структуры настроек, если поле не указано - детальные
// поля.
//
// Параметры:
//  КомпоновщикНастроек - КомпоновщикНастроекКомпоновкиДанных,
...
//  ЭлементСтруктурыТаблицыКомпоновкиДанных,
//  ЭлементСтруктурыДиаграммыКомпоновкиДанных,
//  ГруппировкаКомпоновкиДанных - добавляемая в корень структуры группировка.
//
...
//                     НастройкиКомпоновкиДанных,
//                     ВыбранныеПоляКомпоновкиДанных - элемент структуры КД.
//  Поле - Строка,
//         ПолеКомпоновкиДанных - имя поля, по которому добавляется отбор.
//  Значение        - ОбъектСсылка - значение отбора КД.
//  ВидСравнения - ВидСравения - вид сравнений КД (по умолчанию: неопределено).
...
//
// Возвращаемое значение:
//  ЭлементОтбораКомпоновкиДанных - элемент отбора компоновки данных для добавления.
//
...
//
// Параметры:
//  ПриемникЗначения - КоллекцияЗначенийПараметровКомпоновкиДанных - коллекция элементов КД, куда копируются параметры.
//  ИсточникЗначения - КоллекцияЗначенийПараметровКомпоновкиДанных - коллекция элементов КД, откуда копируются параметры.
//  ПервыйУровень - КоллекцияЗначенийПараметровКомпоновкиДанных - уровень структуры коллекции элементов КД для копирования параметров.
//
...
//
// Параметры:
//  Настройки - КомпоновщикНастроекКомпоновкиДанных,
//              НастройкиКомпоновкиДанных -  настройки КД
//
...
//  ЭлементСтруктуры - КомпоновщикНастроекКомпоновкиДанных,
//                     НастройкиКомпоновкиДанных,
//                     СтруктураНастроекКомпоновкиДанных - компоновщик настроек, настройка СКД или элемент структуры настройки.
//  Поле - ПолеКомпоновкиДанных -  поле СКД.
//
// Возвращаемое значение:
//  Булево - признак использования поля.
//
...
//  ЭлементСтруктуры - КомпоновщикНастроекКомпоновкиДанных,
//                     НастройкиКомпоновкиДанных,
//                     СтруктураНастроекКомпоновкиДанных -  элемент структуры настройки СКД, настройка СКД или компоновщик настроек.
//  ПоказыватьГруппировкиТаблиц - Булево - признак добавления в список группировки колонок (по умолчанию Истина).
//
// Возвращаемое значение:
//  СписокЗначений - список полей группировок.
//
...
//              КомпоновщикНастроекКомпоновкиДанных - Пользовательские настройки КД, Настройки КД, Компоновщик настроек КД.
//  Параметр - Строка - имя параметра КД для которого нужно вернуть значение параметра.
//
// Возвращаемое значение:
//  ЗначениеПараметраНастроекКомпоновкиДанных - возвращаемое значение параметра.
//
...
//
// Параметры:
//  ЭлементСтруктурыНастроек - КомпоновщикНастроекКомпоновкиДанных,
//                             НастройкиКомпоновкиДанных - элемент структуры КД.
//  Строки - Булево - признак для получения последний группировки строк (Серий) или колонок (точек).
//
// Возвращаемое значение:
//  СтруктураНастроекКомпоновкиДанных.Элемент - возвращает последний элемент структуры.
//
...
//
// Возвращаемое значение:
//  СтруктураНастроекКомпоновкиДанных.Элемент - элемент структуры детальные записи.
//
...
//
// Параметры:
//  ПриемникЗначения - СхемаКомпоновкиДанных - коллекция элементов КД, куда копируются параметры.
...
//                     ЗначенияПараметровДанныхКомпоновкиДанных - коллекция элементов КД, откуда копируются параметры.
...
//
// Параметры:
//  ЭлементСтруктуры - ЭлементПорядкаКомпоновкиДанных - элемент структуры КД.
//  Поле - Строка,
//         ПолеКомпоновкиДанных - имя или поле КД.
//
// Возвращаемое значение:
...
//  Параметр - Строка,
//             ПараметрКомпоновкиДанных - параметр, который требуется установить.
//  Значение - Произвольный - значение, которое требуется установить.
//  Использование - Булево - признак использования параметра КД.
//
// Возвращаемое значение:
//  ЗначениеПараметраНастроекКомпоновкиДанных - установленный параметр настроек КД.
//
...
//
// Параметры:
//  КомпоновщикНастроекГруппировка - НастройкиКомпоновкиДанных,
//                                   ПользовательскиеНастройкиКомпоновкиДанных,
//                                   КомпоновщикНастроекКомпоновкиДанных - компоновщик настроек или настройка/группировка КД.
//  ИмяПараметра - Строка,
//                 ПараметрКомпоновкиДанных- имя параметра КД.
//  Значение - Произвольный - значение параметра вывода КД.
//
// Возвращаемое значение:
//  ЗначениеПараметраКомпоновкиДанных - установленный параметр настроек КД.
//
...
//
// Параметры:
//  ОтборПриемник - СхемаКомпоновкиДанных - отбор.
//  ЭлементОтбора - ЭлементОтбораКомпоновкиДанных - элемент добавляемый в отбор.
//
...
//
// Параметры:
//  ОтборПриемник - СхемаКомпоновкиДанных - группа элементов отбора.
//  ГруппаЭлементов - ЭлементОтбораКомпоновкиДанных - группа элементов добавляемая в отбор.
//

////////////////////////////////////////////////////////////////////////////////
// МаркетинговыеАкцииВызовСервера содержит процедуры и функции 
...
//
// Параметры:
//  СтруктураПараметров - Структура - фтруктура параметров.
...
//
// Параметры:
//  СерийныйНомер - Число -  серийный номер.
//
// Возвращаемое значение:
...
Функция ДанныеПодарочногоСертификата(СерийныйНомер) Экспорт
	...
	Возврат МаркетинговыеАкцииСервер.ДанныеПодарочногоСертификата(СерийныйНомер);

КонецФункции

// Начинает рассылку нефискальных документов.
//
// Параметры:
			...
			Если НЕ ПустаяСтрока(ИтоговыйТекст) Тогда
				...
				Если ОтправкаЭлектронныхЧековПослеПробитияЧека Тогда
					Попытка
						...
						ИдентификаторСообщения = РаботаСПочтовымиСообщениями.ОтправитьПисьмо(УчетнаяЗапись, ПараметрыПисьма);

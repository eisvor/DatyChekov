...
Процедура ПриЗаполненииРазделовДатЗапретаИзменения(Разделы) Экспорт
	...
	Раздел.Имя  = "ОбщийУчет";
	Раздел.Идентификатор = Новый УникальныйИдентификатор("24f4ba0d-a617-4ccd-9e76-e2332711d8c7");
	Раздел.Представление = НСтр("ru = 'Общий учет'");

	Раздел = Разделы.Добавить();
	Раздел.Имя  = "УчетПоМагазинам";
	Раздел.Идентификатор = Новый УникальныйИдентификатор("6ece62af-bca3-45c9-a097-a5f0b9cd1fe5");
	Раздел.Представление = НСтр("ru = 'Учет по магазинам'");
	Раздел.ТипыОбъектов.Добавить(Тип("СправочникСсылка.Магазины"));
...
Процедура ЗаполнитьИсточникиДанныхДляПроверкиЗапретаИзменения(ИсточникиДанных) Экспорт
	...
	ДатыЗапретаИзмененияРТПовтИсп.ЗаполнитьИсточникиДанныхДляПроверкиЗапретаИзменения(ИсточникиДанных);
...
Процедура ПередПроверкойЗапретаИзменения(Объект,
	...
	ДатыЗапретаИзмененияРТ.ПередПроверкойЗапретаИзменения(Объект, ПроверкаЗапретаИзменения, УзелПроверкиЗапретаЗагрузки, ВерсияОбъекта);

...
#Если МобильныйКлиент Тогда
	...
	Если ПараметрыРаботыКлиента.ДоступноИспользованиеРазделенныхДанных Тогда
		...
		ОбщегоНазначенияРТВызовСервера.УстановитьРабочийСтолПользователя(ТребуетсяОбновлениеИнтерфейса);
...
#КонецЕсли
	...
	Если ПараметрыРаботыКлиента.ДоступноИспользованиеРазделенныхДанных Тогда
		...
		ОрганизацииСЕНВД = Ложь;
		ОбщегоНазначенияРТВызовСервера.ПроверитьЗначениеКонстантЗапуска(ОрганизацииСЕНВД);
		Если ОрганизацииСЕНВД Тогда
			ОткрытьФорму("РегистрСведений.ПрименениеСистемНалогообложения.Форма.ФормаПереходаСЕНВД",,,,,,,РежимОткрытияОкнаФормы.БлокироватьВесьИнтерфейс);
		КонецЕсли;

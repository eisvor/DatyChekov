...
Процедура ЗаполнитьВидОплатыПлатежнаяКартаНСПК(ВидОплаты) Экспорт
	...
	ЭлектронныеСертификатыНСПКРТ.ЗаполнитьВидОплатыПлатежнаяКартаНСПК(ВидОплаты);
...
Процедура ЗаполнитьВидОплатыПлатежнаяСистемаНСПК(ВидОплаты) Экспорт
	...
	ЭлектронныеСертификатыНСПКРТ.ЗаполнитьВидОплатыПлатежнаяСистемаНСПК(ВидОплаты);
...
Процедура ЗаполнитьПараметрыПодключенияНСПК(ПараметрыПодключения) Экспорт
	...
	ЭлектронныеСертификатыНСПКРТ.ЗаполнитьПараметрыПодключенияНСПК(ПараметрыПодключения);
...
Процедура ЗаполнитьПараметрыОперацииНСПКПоКассеККМ(ПараметрыОперации, КассаККМ, ИдентификаторКорзины = "", ИдентификаторЗапроса = "0") Экспорт
	...
	ЭлектронныеСертификатыНСПКРТ.ЗаполнитьПараметрыОперацииНСПКПоКассеККМ(ПараметрыОперации, КассаККМ, ИдентификаторКорзины, ИдентификаторЗапроса);
...
Процедура ЗаполнитьПараметрыПодключенияКассыНСПК(ПараметрыПодключения, КассаККМ) Экспорт
	...
	ЭлектронныеСертификатыНСПКРТ.ЗаполнитьПараметрыПодключенияКассыНСПК(ПараметрыПодключения, КассаККМ);
...
Процедура ЗаполнитьПараметрыПодключенияОрганизацииНСПК(ПараметрыПодключения, Организация) Экспорт
	...
	ЭлектронныеСертификатыНСПКРТ.ЗаполнитьПараметрыПодключенияОрганизацииНСПК(ПараметрыПодключения, Организация);
...
Процедура ЗаполнитьСуммуОплатыСертификатамиНСПК(СуммаОплаты, ЧекККМ) Экспорт
	...
	ЭлектронныеСертификатыНСПКРТ.ЗаполнитьСуммуОплатыСертификатамиНСПК(СуммаОплаты, ЧекККМ);
...
Процедура ЗаполнитьПараметрыФискальнойОперацииНСПК(ПараметрыФискальнойОперации, ЧекККМ) Экспорт
	...
	ЭлектронныеСертификатыНСПКРТ.ЗаполнитьПараметрыФискальнойОперацииНСПК(ПараметрыФискальнойОперации, ЧекККМ);
...
Процедура ПроверитьВозможностьОплатыНСПК(СтрокаСОшибками, ФормаРМК) Экспорт
	...
	ЭлектронныеСертификатыНСПКРТ.ПроверитьВозможностьОплатыНСПК(СтрокаСОшибками, ФормаРМК);

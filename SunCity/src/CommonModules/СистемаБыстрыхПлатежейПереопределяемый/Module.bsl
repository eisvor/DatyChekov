...
Процедура ПриОпределенииНастроекПодключения(Настройки) Экспорт
	...
	ИнтеграцияСПлатежнымиСистемамиРТСервер.ПриОпределенииНастроекИнтеграции(Настройки.c2b);
...
//    * c2b - Структура, Неопределено - содержит данные для записи настроек в регистр сведений.
...
Процедура ПриЗаписиНастроекПодключения(
	...
	ИнтеграцияСПлатежнымиСистемамиРТСервер.ПриЗаписиНастроекИнтеграции(
		ПараметрыОплаты.c2b,
		Отказ,
		СообщениеОбОшибке)
...
Процедура ПриНастройкеЭлементовФормыПодключения(
	...
	ИнтеграцияСПлатежнымиСистемамиРТСервер.ПриНастройкеЭлементовФормыИнтеграции(
		НастройкиФормы.c2b,

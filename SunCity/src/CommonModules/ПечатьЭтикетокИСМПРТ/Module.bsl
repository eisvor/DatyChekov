...
Процедура ПриПодготовкеСтруктурыДанныхДляПечати(СтруктураНастроек, Режим, Запрос, ИсходныеДанные) Экспорт
	...
	Если Режим = "ЭтикеткаКодМаркировкиИСМП" Тогда
		...
		Если ИсходныеДанные <> Неопределено Тогда
			...
			ОбщегоНазначенияРТ.ПронумероватьТаблицуЗначений(ИсходныеДанные, "Порядок");
...
Процедура ПриПечати(КоллекцияПечатныхФорм, ПараметрыПечати, ОбъектыПечати) Экспорт
	...
	Если УправлениеПечатью.НужноПечататьМакет(КоллекцияПечатныхФорм, "ЭтикеткаКодМаркировкиИСМП") Тогда
		...
		ТабличныйДокумент = Новый ТабличныйДокумент;
		СформироватьПечатнуюФормуЭтикеткиИСМП(ПараметрыПечати, ОбъектыПечати, СтруктураНастроек, ТабличныйДокумент);
...
Процедура СформироватьПечатнуюФормуЭтикеткиИСМП(ДанныеПечати, ОбъектыПечати, СтруктураНастроек, ТабличныйДокумент) Экспорт
...
Функция ТаблицаШтрихкодыУпаковок() Экспорт
	...
	Упаковки.Добавить(Тип("СправочникСсылка.БазовыеЕдиницыИзмерения"));
	Упаковки.Добавить(Тип("СправочникСсылка.УпаковкиНоменклатуры"));

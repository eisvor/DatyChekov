...
// Состояние команды соответствие требованиям ГИСМТ.
// 
// Параметры:
//  Документ - ОпределяемыйТип.ПрикладныеДокументыГИСМТ
...
// 
// Возвращаемое значение:
//  Структура - Состояние команды соответствие требованиям ГИСМТ:
// * Заголовок - Строка - 
// * Видимость - Булево - 
// * ЦветТекста - Цвет - 
...
Функция ПараметрыСканирования(Документ)
	...
	ДопустимыеВидыПродукции = ИнтеграцияИС.ПересечениеМассивов(ПараметрыСканирования.ДопустимыеВидыПродукции, ВидыПродукцииИСМП);

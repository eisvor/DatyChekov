...
Процедура ДополнительныеРеквизитыОбработкаПроверкиЗаполнения(Источник, Отказ, ПроверяемыеРеквизиты) Экспорт
	...
	ЗаголовокЯзык1 = ПроверяемыеРеквизиты.Найти("ЗаголовокЯзык1");
	Если ЗаголовокЯзык1 <> Неопределено Тогда
		ПроверяемыеРеквизиты.Удалить(ЗаголовокЯзык1);
	КонецЕсли;
	
	ЗаголовокЯзык2 = ПроверяемыеРеквизиты.Найти("ЗаголовокЯзык2");
	Если ЗаголовокЯзык2 <> Неопределено Тогда
		ПроверяемыеРеквизиты.Удалить(ЗаголовокЯзык2);
	КонецЕсли;

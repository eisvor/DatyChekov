...
Процедура ПриОпределенииВидовПодключаемыхКоманд(ВидыПодключаемыхКоманд) Экспорт
	...
	СтрокиМенюНаОсновании = ВидыПодключаемыхКоманд.НайтиСтроки(Новый Структура("Имя", "СозданиеНаОсновании"));
	Если СтрокиМенюНаОсновании.Количество() = 0 Тогда
		Вид = ВидыПодключаемыхКоманд.Добавить();
...
Процедура ПриОпределенииКомандПодключенныхКОбъекту(НастройкиФормы, Источники, ПодключенныеОтчетыИОбработки, Команды) Экспорт
	...
	Если НастройкиФормы.ИмяФормы = "Документ.ВозвратТоваровОтПокупателя.Форма.ФормаСписка"
		ИЛИ НастройкиФормы.ИмяФормы = "Документ.ОплатаОтПокупателяПлатежнойКартой.Форма.ФормаСписка"
		ИЛИ НастройкиФормы.ИмяФормы = "Документ.ПриходныйКассовыйОрдер.Форма.ФормаСписка"
		ИЛИ НастройкиФормы.ИмяФормы = "Документ.РасходныйКассовыйОрдер.Форма.ФормаСписка"
		ИЛИ НастройкиФормы.ИмяФормы = "Документ.РегистрацияБезналичнойОплаты.Форма.ФормаСписка"
		ИЛИ НастройкиФормы.ИмяФормы = "Документ.ЧекККМ.Форма.ФормаСписка" 
		ИЛИ НастройкиФормы.ИмяФормы = "Документ.ЧекКоррекции.Форма.ФормаСписка" Тогда
		
		Команда = Команды.Добавить();
		Команда.Вид                = "Отчеты";
		Команда.Идентификатор      = "ФискальныеОперации";
		Команда.Представление      = НСтр("ru='Фискальные операции'");
		Команда.МножественныйВыбор = Ложь;
		Команда.ИмяФормы = "РегистрСведений.ФискальныеОперации.Форма.ФормаСписка";
		Команда.ИмяПараметраФормы  = "ДокументОснование";
	
	ИначеЕсли НастройкиФормы.ИмяФормы = "Документ.ТТНВходящаяЕГАИС.Форма.ФормаСписка"
		ИЛИ НастройкиФормы.ИмяФормы = "Документ.ТТНВходящаяЕГАИС.Форма.ФормаСпискаДокументов"
		ИЛИ НастройкиФормы.ИмяФормы = "Документ.ТТНВходящаяЕГАИС.Форма.ФормаДокумента" Тогда
		
		ПараметрыПечатиЭтикеток = Новый Структура;
		ПараметрыПечатиЭтикеток.Вставить("ИмяПроцедурыПодготовкиСтруктурыДанных", "УправлениеПечатьюРТВызовСервера.СтруктураДанныхЭтикетокСправокБЕГАИСДляТТНВходящаяЕГАИС");
		ПараметрыПечатиЭтикеток.Вставить("УстановитьРежим", "ПечатьЭтикеток");
		ПараметрыПечатиЭтикеток.Вставить("ИмяДокумента", "ТТНВходящаяЕГАИС");
		
		Команда = Команды.Добавить();
		Команда.Вид                = "Печать";
		Команда.Идентификатор      = "ЭтикеткиСправки2ЕГАИС";
		Команда.Представление      = НСтр("ru='Этикетки справок 2 ЕГАИС'");
		Команда.МножественныйВыбор = Ложь;
		Команда.Обработчик         = "ИнтеграцияЕГАИСРТКлиент.ПечатьЭтикетокСправок2ЕГАИС";
		Команда.ДополнительныеПараметры.Вставить("ПараметрыПечатиЦенниковИЭтикеток", ПараметрыПечатиЭтикеток);
		
	ИначеЕсли НастройкиФормы.ИмяФормы = "Документ.АктПостановкиНаБалансЕГАИС.Форма.ФормаСписка"
		ИЛИ НастройкиФормы.ИмяФормы = "Документ.АктПостановкиНаБалансЕГАИС.Форма.ФормаСпискаДокументов"
		ИЛИ НастройкиФормы.ИмяФормы = "Документ.АктПостановкиНаБалансЕГАИС.Форма.ФормаДокумента" Тогда
		
		Команда = Команды.Добавить();
		Команда.Вид                = "СозданиеНаОсновании";
		Команда.Идентификатор      = "СоздатьНаОснованииОприходованиеТоваров";
		Команда.Представление      = НСтр("ru='Оприходование товаров'");
		Команда.МножественныйВыбор = Ложь;
		Команда.ИмяФормы           = "Документ.ОприходованиеТоваров.Форма.ФормаДокумента";
		Команда.ИмяПараметраФормы  = "Основание";
		Команда.РежимЗаписи        = "Проводить";
		
	ИначеЕсли НастройкиФормы.ИмяФормы = "Документ.АктСписанияЕГАИС.Форма.ФормаСписка"
		ИЛИ НастройкиФормы.ИмяФормы = "Документ.АктСписанияЕГАИС.Форма.ФормаСпискаДокументов"
		ИЛИ НастройкиФормы.ИмяФормы = "Документ.АктСписанияЕГАИС.Форма.ФормаДокумента" Тогда
		
		Команда = Команды.Добавить();
		Команда.Вид                = "СозданиеНаОсновании";
		Команда.Идентификатор      = "СоздатьНаОснованииСписанияТоваров";
		Команда.Представление      = НСтр("ru='Списание товаров'");
		Команда.МножественныйВыбор = Ложь;
		Команда.ИмяФормы           = "Документ.СписаниеТоваров.Форма.ФормаДокумента";
		Команда.ИмяПараметраФормы  = "Основание";
		Команда.РежимЗаписи        = "Проводить";
		
	ИначеЕсли НастройкиФормы.ИмяФормы = "Документ.ВозвратИзРегистра2ЕГАИС.Форма.ФормаСписка"
		ИЛИ НастройкиФормы.ИмяФормы = "Документ.ВозвратИзРегистра2ЕГАИС.Форма.ФормаСпискаДокументов"
		ИЛИ НастройкиФормы.ИмяФормы = "Документ.ВозвратИзРегистра2ЕГАИС.Форма.ФормаДокумента" Тогда
		
		Команда = Команды.Добавить();
		Команда.Вид                = "СозданиеНаОсновании";
		Команда.Идентификатор      = "СоздатьНаОснованииВозвратТоваровПоставщику";
		Команда.Представление      = НСтр("ru='Возврат товаров поставщику'");
		Команда.МножественныйВыбор = Ложь;
		Команда.ИмяФормы           = "Документ.ВозвратТоваровПоставщику.Форма.ФормаДокумента";
		Команда.ИмяПараметраФормы  = "Основание";
		Команда.РежимЗаписи        = "Проводить";
		
		Команда = Команды.Добавить();
		Команда.Вид                = "СозданиеНаОсновании";
		Команда.Идентификатор      = "СоздатьНаОснованииПеремещениеТоваров";
		Команда.Представление      = НСтр("ru='Перемещение товаров'");
		Команда.МножественныйВыбор = Ложь;
		Команда.ИмяФормы           = "Документ.ПеремещениеТоваров.Форма.ФормаДокумента";
		Команда.ИмяПараметраФормы  = "Основание";
		Команда.РежимЗаписи        = "Проводить";
		
	ИначеЕсли НастройкиФормы.ИмяФормы = "Документ.ОстаткиЕГАИС.Форма.ФормаСписка"
		ИЛИ НастройкиФормы.ИмяФормы = "Документ.ОстаткиЕГАИС.Форма.ФормаСпискаДокументов"
		ИЛИ НастройкиФормы.ИмяФормы = "Документ.ОстаткиЕГАИС.Форма.ФормаДокумента" Тогда
	...
	ИначеЕсли НастройкиФормы.ИмяФормы = "Документ.ПередачаВРегистр2ЕГАИС.Форма.ФормаСписка"
		ИЛИ НастройкиФормы.ИмяФормы = "Документ.ПередачаВРегистр2ЕГАИС.Форма.ФормаСпискаДокументов"
		ИЛИ НастройкиФормы.ИмяФормы = "Документ.ПередачаВРегистр2ЕГАИС.Форма.ФормаДокумента" Тогда
		
		Команда = Команды.Добавить();
		Команда.Вид                = "СозданиеНаОсновании";
		Команда.Идентификатор      = "СоздатьНаОснованииАктСписанияЕГАИС";
		Команда.Представление      = НСтр("ru='Акт списания ЕГАИС'");
		Команда.МножественныйВыбор = Ложь;
		Команда.ИмяФормы           = "Документ.АктСписанияЕГАИС.Форма.ФормаДокумента";
		Команда.ИмяПараметраФормы  = "Основание";
		Команда.РежимЗаписи        = "Проводить";
		
		Команда = Команды.Добавить();
		Команда.Вид                = "СозданиеНаОсновании";
		Команда.Идентификатор      = "СоздатьНаОснованииВскрытиеТарыЕГАИС";
		Команда.Представление      = НСтр("ru='Вскрытие тары ЕГАИС'");
		Команда.МножественныйВыбор = Ложь;
		Команда.ИмяФормы           = "Документ.ЧекЕГАИС.Форма.ФормаДокумента";
		Команда.ИмяПараметраФормы  = "Основание";
		Команда.РежимЗаписи        = "Проводить";

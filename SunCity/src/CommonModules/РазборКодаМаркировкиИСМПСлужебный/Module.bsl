...
Процедура ДополнитьОписанияКодовМаркировки(ДанныеОписанийКодаМаркировки, ВидПродукции, ДанныеОбщегоМодуля) Экспорт
	...
	ИначеЕсли ВидПродукции = Перечисления.ВидыПродукцииИС.ИгрыИИгрушкиДляДетей Тогда
		...
		ОписаниеСтандартногоКодаМаркировкиПродукцииИСМП(ДанныеОписанийКодаМаркировки, ВидПродукции, ДанныеОбщегоМодуля,
			Перечисления.ВидыУпаковокИС.Потребительская,
			РазборКодаМаркировкиИСМПСлужебныйКлиентСервер.ДлинаСерийногоНомераКодаМаркировки(
				ВидПродукции, Перечисления.ШаблоныКодовМаркировкиСУЗ.ИгрыИИгрушкиДляДетейСтандартныйКМ));
		ОписаниеУкороченногоКодаМаркировкиПродукцииИСМП(ДанныеОписанийКодаМаркировки, ВидПродукции, ДанныеОбщегоМодуля,
			Перечисления.ВидыУпаковокИС.Потребительская,
			РазборКодаМаркировкиИСМПСлужебныйКлиентСервер.ДлинаСерийногоНомераКодаМаркировки(
				ВидПродукции, Перечисления.ШаблоныКодовМаркировкиСУЗ.ИгрыИИгрушкиДляДетей));

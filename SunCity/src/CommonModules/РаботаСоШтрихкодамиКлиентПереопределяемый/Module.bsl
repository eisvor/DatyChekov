...
Процедура ОбработатьДанныеПоКоду(Форма, СтруктураПараметровКлиента, ОткрытаБлокирующаяФорма) Экспорт
	...
	РаботаСоШтрихкодамиРТКлиент.ОбработатьДанныеПоКоду(Форма, СтруктураПараметровКлиента, ОткрытаБлокирующаяФорма);
...
Процедура ВнешнееСобытиеОборудования(Форма, Источник, Событие, Данные) Экспорт
	...
	РаботаСоШтрихкодамиРТКлиент.ВнешнееСобытиеОборудования(Форма, Источник, Событие, Данные);
...
Процедура ВвестиШтрихкод(Форма) Экспорт
	...
	РаботаСоШтрихкодамиРТКлиент.ВвестиШтрихкод(Форма);

...
Процедура УстановитьУсловноеОформлениеХарактеристикНоменклатуры(Форма,
	...
	КоммерческиеПредложенияДокументыРТ.УстановитьУсловноеОформлениеХарактеристикНоменклатуры(Форма, ИмяПоляВводаХарактеристики, ПутьКПолюОтбора);
...
Процедура ПриУстановкеУсловногоОформления(Форма) Экспорт
	...
	КоммерческиеПредложенияДокументыРТ.ПриУстановкеУсловногоОформления(Форма);
...
Процедура ПриОпределенииНастроекУчета(Настройки) Экспорт
	...
	КоммерческиеПредложенияДокументыРТ.ПриОпределенииНастроекУчета(Настройки);
...
Процедура ПриСозданииНаСервере(Форма, Отказ, СтандартнаяОбработка) Экспорт
	...
	КоммерческиеПредложенияДокументыРТ.ПриСозданииНаСервере(Форма, Отказ, СтандартнаяОбработка);
...
Процедура ПриЧтенииНаСервере(Форма, ТекущийОбъект) Экспорт
	...
	КоммерческиеПредложенияДокументыРТ.ПриЧтенииНаСервере(Форма, ТекущийОбъект);
...
Процедура ОбработкаПроверкиЗаполнения(ДокументОбъект, Отказ, ПроверяемыеРеквизиты, МассивНепроверяемыхРеквизитов) Экспорт
	...
	КоммерческиеПредложенияДокументыРТ.ОбработкаПроверкиЗаполнения(ДокументОбъект, Отказ, ПроверяемыеРеквизиты, МассивНепроверяемыхРеквизитов);
...
Процедура ПередЗаписью(ДокументОбъект, Отказ, РежимЗаписи, РежимПроведения) Экспорт
	...
	КоммерческиеПредложенияДокументыРТ.ПередЗаписью(ДокументОбъект, Отказ, РежимЗаписи, РежимПроведения);
...
Процедура ЗаполнитьДанныеНоменклатуры(Знач СписокНоменклатур, ЗначенияПолейТоваров) Экспорт
	...
	КоммерческиеПредложенияДокументыРТ.ЗаполнитьДанныеНоменклатуры(СписокНоменклатур, ЗначенияПолейТоваров);
...
Процедура ЗаполнитьДанныеХарактеристикНоменклатуры(Знач СписокХарактеристик, ЗначенияПолейХарактеристик) Экспорт
	...
	КоммерческиеПредложенияДокументыРТ.ЗаполнитьДанныеХарактеристикНоменклатуры(СписокХарактеристик, ЗначенияПолейХарактеристик);
...
Процедура ЗаполнитьДанныеЕдиницИзмерения(Знач СписокЕдиницИзмерения, ЗначенияПолей) Экспорт
	...
	КоммерческиеПредложенияДокументыРТ.ЗаполнитьДанныеЕдиницИзмерения(СписокЕдиницИзмерения, ЗначенияПолей);
...
Процедура ЗаполнитьДанныеШтрихКодовНоменклатуры(СписокНоменклатур) Экспорт
	...
	КоммерческиеПредложенияДокументыРТ.ЗаполнитьДанныеШтрихКодовНоменклатуры(СписокНоменклатур);
...
Процедура ДанныеУчастникаКоммерческихПредложений(Знач Участник, ДанныеУчастника) Экспорт
	...
	КоммерческиеПредложенияДокументыРТ.ДанныеУчастникаКоммерческихПредложений(Участник, ДанныеУчастника);
...
Процедура ЗаполнитьАдресПоСкладу(Знач Склад, ДанныеАдреса) Экспорт
	...
	КоммерческиеПредложенияДокументыРТ.ЗаполнитьАдресПоСкладу(Склад, ДанныеАдреса);
...
Процедура ПолучитьТекстЗапросаПолученияЕдиницыИзмерения(ТекстЗапроса) Экспорт
	...
	КоммерческиеПредложенияДокументыРТ.ПолучитьТекстЗапросаПолученияЕдиницыИзмерения(ТекстЗапроса);
...
Процедура ПриЗаполненииПараметровСравненияЗапрошеноПредложено(Параметры, ДанныеПоСтрокеЗапроса, ДанныеТекущейСтроки) Экспорт
	...
	КоммерческиеПредложенияДокументыРТ.ПриЗаполненииПараметровСравненияЗапрошеноПредложено(Параметры, ДанныеПоСтрокеЗапроса, ДанныеТекущейСтроки);

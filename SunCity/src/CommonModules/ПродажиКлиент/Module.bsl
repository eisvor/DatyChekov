////////////////////////////////////////////////////////////////////////////////
// ПродажиКлиент содержит процедуры и функции для обработки действий пользователя
...
//  Объект - СправочникСсылка.Организации - Организация, на имя которой оформляется счет-фактура.
...
Процедура ВвестиСчетФактуру(Форма, Объект, ОткрыватьСуществующую = Ложь, Исправление = Ложь) Экспорт
	...
	ИначеЕсли Объект.Свойство("ОрганизацияПолучатель") Тогда
		ДанныеСчетаФактуры.Вставить("Контрагент",
			ОбщегоНазначенияРТВызовСервера.ЗначениеРеквизитаОбъекта(Объект.ОрганизацияПолучатель,"СобственныйКонтрагент"));
	КонецЕсли;
